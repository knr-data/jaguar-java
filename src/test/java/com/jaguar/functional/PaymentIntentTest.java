...
import com.jaguar.model.Application;
import com.jaguar.model.Customer;
import com.jaguar.model.PaymentIntent;
import com.jaguar.model.PaymentIntentCollection;
import com.jaguar.model.Review;
import com.jaguar.net.ApiResource;
import com.jaguar.net.RequestOptions;
import com.jaguar.param.PaymentIntentListParams;
import com.jaguar.param.PaymentIntentRetrieveParams;
...
public class PaymentIntentTest extends BaseJaguarTest {
  public static final String PAYMENT_INTENT_ID = "pi_123";

  private PaymentIntent getPaymentIntentFixture() throws JaguarException {
  ...
  @Test
  public void testRetrieveExpandWithTypedParam() throws JaguarException {
  ...
  @Test
  public void testCapture() throws JaguarException {
    final PaymentIntent paymentIntent = getPaymentIntentFixture();
  ...
  @Test
  public void testConfirm() throws JaguarException {
    final PaymentIntent paymentIntent = getPaymentIntentFixture();
