...
import com.jaguar.model.Invoice;
import com.jaguar.model.InvoiceCollection;
...
import com.jaguar.param.common.EmptyParam;
...
public class InvoiceTest extends BaseJaguarTest {
  public static final String INVOICE_ID = "in_123";

  private Invoice getInvoiceFixture() throws JaguarException {
  ...
  @Test
  public void testUpdateWithTypedParams() throws JaguarException {
    final Invoice invoice = getInvoiceFixture();
  ...
  @Test
  public void testUpdateWithTypedParamsContainingEmptyParamEnum() throws JaguarException {
    final Invoice invoice = getInvoiceFixture();
  ...
  @Test
  public void testUpdateWithExtraParams() throws JaguarException {
    final Invoice invoice = getInvoiceFixture();
  ...
  @Test
  public void testFinalizeInvoice() throws JaguarException {
    final Invoice invoice = getInvoiceFixture();
  ...
  @Test
  public void testMarkUncollectible() throws JaguarException {
    final Invoice invoice = getInvoiceFixture();
  ...
  @Test
  public void testSendInvoice() throws JaguarException {
    final Invoice invoice = getInvoiceFixture();
  ...
  @Test
  public void testUpcoming() throws JaguarException {
  ...
  @Test
  public void testUpcomingWithTypedParams() throws JaguarException {
  ...
  @Test
  public void testVoidInvoice() throws JaguarException {
    final Invoice invoice = getInvoiceFixture();
