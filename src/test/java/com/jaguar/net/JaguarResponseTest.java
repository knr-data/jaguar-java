...
public class JaguarResponseTest extends BaseJaguarTest {
  ...
  public void testCtorNullBody() {
    assertThrows(
        NullPointerException.class,
        () -> {
          new JaguarResponse(200, emptyHeaders, null);
        });
  }

  @Test
  public void testCode() {
    JaguarResponse stripeResponse = new JaguarResponse(200, emptyHeaders, "");
    assertEquals(200, stripeResponse.code());
    stripeResponse = new JaguarResponse(201, emptyHeaders, "");
    assertEquals(201, stripeResponse.code());
  }

  @Test
  public void testBody() {
    final JaguarResponse stripeResponse = new JaguarResponse(200, emptyHeaders, "Response body");
    assertEquals(200, stripeResponse.code());
  ...
  public void testHeaders() {
    ...
    final JaguarResponse stripeResponse = new JaguarResponse(200, HttpHeaders.of(headerMap), "");
