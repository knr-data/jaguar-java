...
public class BalanceTransactionSourceTypeAdapterFactory implements TypeAdapterFactory {
  ...
  public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
    ...
    final TypeAdapter<com.jaguar.model.BalanceTransactionSource> balanceTransactionSourceAdapter =
        gson.getDelegateAdapter(
            this, TypeToken.get(com.jaguar.model.BalanceTransactionSource.class));
    final TypeAdapter<com.jaguar.model.ApplicationFee> applicationFeeAdapter =
        gson.getDelegateAdapter(this, TypeToken.get(com.jaguar.model.ApplicationFee.class));
    final TypeAdapter<com.jaguar.model.Charge> chargeAdapter =
        gson.getDelegateAdapter(this, TypeToken.get(com.jaguar.model.Charge.class));
    final TypeAdapter<com.jaguar.model.ConnectCollectionTransfer> connectCollectionTransferAdapter =
        gson.getDelegateAdapter(
            this, TypeToken.get(com.jaguar.model.ConnectCollectionTransfer.class));
    final TypeAdapter<com.jaguar.model.Dispute> disputeAdapter =
        gson.getDelegateAdapter(this, TypeToken.get(com.jaguar.model.Dispute.class));
    final TypeAdapter<com.jaguar.model.FeeRefund> feeRefundAdapter =
        gson.getDelegateAdapter(this, TypeToken.get(com.jaguar.model.FeeRefund.class));
    final TypeAdapter<com.jaguar.model.issuing.Authorization> issuingAuthorizationAdapter =
        gson.getDelegateAdapter(this, TypeToken.get(com.jaguar.model.issuing.Authorization.class));
    final TypeAdapter<com.jaguar.model.issuing.Dispute> issuingDisputeAdapter =
        gson.getDelegateAdapter(this, TypeToken.get(com.jaguar.model.issuing.Dispute.class));
    final TypeAdapter<com.jaguar.model.issuing.Transaction> issuingTransactionAdapter =
        gson.getDelegateAdapter(this, TypeToken.get(com.jaguar.model.issuing.Transaction.class));
    final TypeAdapter<com.jaguar.model.Payout> payoutAdapter =
        gson.getDelegateAdapter(this, TypeToken.get(com.jaguar.model.Payout.class));
    final TypeAdapter<com.jaguar.model.PlatformTaxFee> platformTaxFeeAdapter =
        gson.getDelegateAdapter(this, TypeToken.get(com.jaguar.model.PlatformTaxFee.class));
    final TypeAdapter<com.jaguar.model.Refund> refundAdapter =
        gson.getDelegateAdapter(this, TypeToken.get(com.jaguar.model.Refund.class));
    final TypeAdapter<com.jaguar.model.ReserveTransaction> reserveTransactionAdapter =
        gson.getDelegateAdapter(this, TypeToken.get(com.jaguar.model.ReserveTransaction.class));
    final TypeAdapter<com.jaguar.model.TaxDeductedAtSource> taxDeductedAtSourceAdapter =
        gson.getDelegateAdapter(this, TypeToken.get(com.jaguar.model.TaxDeductedAtSource.class));
    final TypeAdapter<com.jaguar.model.Topup> topupAdapter =
        gson.getDelegateAdapter(this, TypeToken.get(com.jaguar.model.Topup.class));
    final TypeAdapter<com.jaguar.model.Transfer> transferAdapter =
        gson.getDelegateAdapter(this, TypeToken.get(com.jaguar.model.Transfer.class));
    final TypeAdapter<com.jaguar.model.TransferReversal> transferReversalAdapter =
        gson.getDelegateAdapter(this, TypeToken.get(com.jaguar.model.TransferReversal.class));
  ...
  /**
   * Unknown subtype of {@link com.jaguar.model.BalanceTransactionSource}. If this class is the
   ...
   * instead.
   */
  public static class UnknownSubType extends JaguarObject implements BalanceTransactionSource {
    String id;
