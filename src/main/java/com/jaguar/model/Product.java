...
import com.jaguar.param.ProductCreateParams;
import com.jaguar.param.ProductListParams;
import com.jaguar.param.ProductRetrieveParams;
import com.jaguar.param.ProductUpdateParams;
...
public class Product extends ApiResource implements HasId, MetadataStore<Product> {
  ...
  public static Product create(Map<String, Object> params) throws JaguarException {
  ...
  public static Product create(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/products");
    return ApiResource.request(ApiResource.RequestMethod.POST, url, params, Product.class, options);
  }

  /** Creates a new product object. */
  public static Product create(ProductCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
   ...
   * information.
   */
  public static Product retrieve(String id) throws JaguarException {
   ...
   * information.
   */
  public static Product retrieve(String id, RequestOptions options) throws JaguarException {
  ...
  public static Product retrieve(String id, Map<String, Object> params, RequestOptions options)
    ...
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/products/%s", ApiResource.urlEncodeId(id)));
   ...
   */
  @Override
  public Product update(Map<String, Object> params) throws JaguarException {
   ...
   */
  @Override
  public Product update(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * provided will be left unchanged.
   */
  public Product update(ProductUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   * provided will be left unchanged.
   */
  public Product update(ProductUpdateParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  public static ProductCollection list(Map<String, Object> params) throws JaguarException {
   ...
   * most recently created products appearing first.
   */
  public static ProductCollection list(ProductListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   * associated with it.
   */
  public Product delete() throws JaguarException {
   ...
   * associated with it.
   */
  public Product delete(RequestOptions options) throws JaguarException {
   ...
   * associated with it.
   */
  public Product delete(Map<String, Object> params) throws JaguarException {
   ...
   * associated with it.
   */
  public Product delete(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
