...
import com.jaguar.param.PayoutCancelParams;
import com.jaguar.param.PayoutCreateParams;
import com.jaguar.param.PayoutListParams;
import com.jaguar.param.PayoutRetrieveParams;
import com.jaguar.param.PayoutReverseParams;
import com.jaguar.param.PayoutUpdateParams;
...
public class Payout extends ApiResource implements MetadataStore<Payout>, BalanceTransactionSource {
   ...
   * information.
   */
  public static Payout retrieve(String payout) throws JaguarException {
   ...
   * information.
   */
  public static Payout retrieve(String payout, RequestOptions options) throws JaguarException {
  ...
  public static Payout retrieve(String payout, Map<String, Object> params, RequestOptions options)
    ...
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/payouts/%s", ApiResource.urlEncodeId(payout)));
   ...
   * first.
   */
  public static PayoutCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static PayoutCollection list(Map<String, Object> params, RequestOptions options)
      throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/payouts");
   ...
   * first.
   */
  public static PayoutCollection list(PayoutListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   */
  public static Payout create(Map<String, Object> params) throws JaguarException {
   ...
   * pending amounts by source type.
   */
  public static Payout create(PayoutCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
   ...
   */
  @Override
  public Payout update(Map<String, Object> params) throws JaguarException {
   ...
   */
  @Override
  public Payout update(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * provided will be left unchanged. This request accepts only the metadata as arguments.
   */
  public Payout update(PayoutUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   * provided will be left unchanged. This request accepts only the metadata as arguments.
   */
  public Payout update(PayoutUpdateParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  public Payout cancel() throws JaguarException {
   ...
   * refunded to your available balance. You may not cancel automatic Stripe payouts.
   */
  public Payout cancel(RequestOptions options) throws JaguarException {
   ...
   * refunded to your available balance. You may not cancel automatic Stripe payouts.
   */
  public Payout cancel(Map<String, Object> params) throws JaguarException {
   ...
   * refunded to your available balance. You may not cancel automatic Stripe payouts.
   */
  public Payout cancel(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * refunded to your available balance. You may not cancel automatic Stripe payouts.
   */
  public Payout cancel(PayoutCancelParams params) throws JaguarException {
    return cancel(params, (RequestOptions) null);
  }
   ...
   * refunded to your available balance. You may not cancel automatic Stripe payouts.
   */
  public Payout cancel(PayoutCancelParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  public Payout reverse() throws JaguarException {
   ...
   * and that no other authorization is required.
   */
  public Payout reverse(RequestOptions options) throws JaguarException {
   ...
   * and that no other authorization is required.
   */
  public Payout reverse(Map<String, Object> params) throws JaguarException {
   ...
   * and that no other authorization is required.
   */
  public Payout reverse(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * and that no other authorization is required.
   */
  public Payout reverse(PayoutReverseParams params) throws JaguarException {
    return reverse(params, (RequestOptions) null);
  }
   ...
   * and that no other authorization is required.
   */
  public Payout reverse(PayoutReverseParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
