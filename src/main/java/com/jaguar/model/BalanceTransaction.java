...
import com.jaguar.param.BalanceTransactionListParams;
import com.jaguar.param.BalanceTransactionRetrieveParams;
...
public class BalanceTransaction extends ApiResource implements HasId {
  ...
  public static BalanceTransactionCollection list(
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/balance_transactions");
   ...
   */
  public static BalanceTransactionCollection list(
      BalanceTransactionListParams params, RequestOptions options) throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/balance_transactions");
    return ApiResource.requestCollection(url, params, BalanceTransactionCollection.class, options);
  }
   ...
   */
  public static BalanceTransaction retrieve(String id) throws JaguarException {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Fee extends JaguarObject {
