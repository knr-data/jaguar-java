...
import com.jaguar.param.CustomerBalanceTransactionUpdateParams;
...
public class CustomerBalanceTransaction extends ApiResource
   ...
   */
  @Override
  public CustomerBalanceTransaction update(Map<String, Object> params) throws JaguarException {
