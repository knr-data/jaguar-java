...
import com.jaguar.net.UntypedMapDeserializer;
...
public class EventDataDeserializer implements JsonDeserializer<EventData> {
   ...
   */
  static JaguarObject deserializeStripeObject(JsonObject eventDataObjectJson) {
    String type = eventDataObjectJson.getAsJsonObject().get("object").getAsString();
    Class<? extends JaguarObject> cl = EventDataClassLookup.findClass(type);
    return ApiResource.GSON.fromJson(
        eventDataObjectJson, cl != null ? cl : JaguarRawJsonObject.class);
  }
}
