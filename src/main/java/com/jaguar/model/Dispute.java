...
import com.jaguar.param.DisputeCloseParams;
import com.jaguar.param.DisputeListParams;
import com.jaguar.param.DisputeRetrieveParams;
import com.jaguar.param.DisputeUpdateParams;
...
public class Dispute extends ApiResource
  ...
  public static DisputeCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/disputes");
   ...
   */
  public Dispute close() throws JaguarException {
   ...
   * <em>Closing a dispute is irreversible</em>.
   */
  public Dispute close(RequestOptions options) throws JaguarException {
   ...
   * <em>Closing a dispute is irreversible</em>.
   */
  public Dispute close(Map<String, Object> params) throws JaguarException {
   ...
   * <em>Closing a dispute is irreversible</em>.
   */
  public Dispute close(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * <em>Closing a dispute is irreversible</em>.
   */
  public Dispute close(DisputeCloseParams params) throws JaguarException {
    return close(params, (RequestOptions) null);
  }
   ...
   * <em>Closing a dispute is irreversible</em>.
   */
  public Dispute close(DisputeCloseParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class EvidenceDetails extends JaguarObject {
    /**
