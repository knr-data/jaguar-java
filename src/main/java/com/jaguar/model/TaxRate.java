...
import com.jaguar.param.TaxRateCreateParams;
import com.jaguar.param.TaxRateListParams;
import com.jaguar.param.TaxRateRetrieveParams;
import com.jaguar.param.TaxRateUpdateParams;
...
public class TaxRate extends ApiResource implements HasId, MetadataStore<TaxRate> {
   ...
   */
  public static TaxRateCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static TaxRateCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/tax_rates");
   ...
   * recently created tax rates appearing first.
   */
  public static TaxRateCollection list(TaxRateListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
  ...
  public static TaxRate retrieve(String taxRate) throws JaguarException {
    return retrieve(taxRate, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves a tax rate with the given ID. */
  public static TaxRate retrieve(String taxRate, RequestOptions options) throws JaguarException {
  ...
  public static TaxRate retrieve(
      String taxRate, TaxRateRetrieveParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  public static TaxRate create(Map<String, Object> params) throws JaguarException {
  ...
  /** Creates a new tax rate. */
  public static TaxRate create(TaxRateCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  @Override
  public TaxRate update(Map<String, Object> params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }

  /** Updates an existing tax rate. */
  @Override
  public TaxRate update(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  /** Updates an existing tax rate. */
  public TaxRate update(TaxRateUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }

  /** Updates an existing tax rate. */
  public TaxRate update(TaxRateUpdateParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
