...
public class EphemeralKey extends ApiResource implements HasId {
  ...
  public EphemeralKey delete() throws JaguarException {
    return delete(null);
  }

  /** Invalidates an ephemeral API key for a given resource. */
  public EphemeralKey delete(RequestOptions options) throws JaguarException {
    return request(
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class AssociatedObject extends JaguarObject implements HasId {
    @Getter(onMethod_ = {@Override})
    String id;
