...
import com.jaguar.param.OrderCreateParams;
import com.jaguar.param.OrderListParams;
import com.jaguar.param.OrderPayParams;
import com.jaguar.param.OrderRetrieveParams;
import com.jaguar.param.OrderReturnOrderParams;
import com.jaguar.param.OrderUpdateParams;
...
public class Order extends ApiResource implements HasId, MetadataStore<Order> {
  ...
  public static Order create(Map<String, Object> params) throws JaguarException {
  ...
  public static Order create(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/orders");
    return ApiResource.request(ApiResource.RequestMethod.POST, url, params, Order.class, options);
  }

  /** Creates a new order object. */
  public static Order create(OrderCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
   ...
   */
  public static OrderCollection list(Map<String, Object> params) throws JaguarException {
   ...
   * recently created orders appearing first.
   */
  public static OrderCollection list(OrderListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   */
  public static Order retrieve(String id) throws JaguarException {
   ...
   * creation request or the order list, and Stripe will return the corresponding order information.
   */
  public static Order retrieve(String id, RequestOptions options) throws JaguarException {
  ...
  public static Order retrieve(String id, Map<String, Object> params, RequestOptions options)
    ...
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/orders/%s", ApiResource.urlEncodeId(id)));
   ...
   */
  @Override
  public Order update(Map<String, Object> params) throws JaguarException {
   ...
   */
  @Override
  public Order update(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * provided will be left unchanged.
   */
  public Order update(OrderUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   * provided will be left unchanged.
   */
  public Order update(OrderUpdateParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  public Order pay() throws JaguarException {
    return pay((Map<String, Object>) null, (RequestOptions) null);
  }

  /** Pay an order by providing a <code>source</code> to create a payment. */
  public Order pay(RequestOptions options) throws JaguarException {
    return pay((Map<String, Object>) null, options);
  }

  /** Pay an order by providing a <code>source</code> to create a payment. */
  public Order pay(Map<String, Object> params) throws JaguarException {
    return pay(params, (RequestOptions) null);
  }

  /** Pay an order by providing a <code>source</code> to create a payment. */
  public Order pay(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  /** Pay an order by providing a <code>source</code> to create a payment. */
  public Order pay(OrderPayParams params) throws JaguarException {
    return pay(params, (RequestOptions) null);
  }

  /** Pay an order by providing a <code>source</code> to create a payment. */
  public Order pay(OrderPayParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * started in.
   */
  public OrderReturn returnOrder() throws JaguarException {
   ...
   * started in.
   */
  public OrderReturn returnOrder(RequestOptions options) throws JaguarException {
   ...
   * started in.
   */
  public OrderReturn returnOrder(Map<String, Object> params) throws JaguarException {
   ...
   * started in.
   */
  public OrderReturn returnOrder(OrderReturnOrderParams params) throws JaguarException {
    return returnOrder(params, (RequestOptions) null);
  }
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class ShippingMethod extends JaguarObject implements HasId {
    /**
     * A positive integer in the smallest currency unit (that is, 100 cents for $1.00, or 1 for ¥1,
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class DeliveryEstimate extends JaguarObject {
      /**
