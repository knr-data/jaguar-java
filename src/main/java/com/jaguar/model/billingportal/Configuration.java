...
import com.jaguar.param.billingportal.ConfigurationListParams;
import com.jaguar.param.billingportal.ConfigurationRetrieveParams;
...
public class Configuration extends ApiResource implements HasId, MetadataStore<Configuration> {
  ...
  public static ConfigurationCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static ConfigurationCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/billing_portal/configurations");
  ...
  public static Configuration create(Map<String, Object> params) throws JaguarException {
  ...
  /** Creates a configuration that describes the functionality and behavior of a PortalSession. */
  public static Configuration create(ConfigurationCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  @Override
  public Configuration update(Map<String, Object> params) throws JaguarException {
  ...
  /** Updates a configuration that describes the functionality of the customer portal. */
  public Configuration update(ConfigurationUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
  ...
  public static Configuration retrieve(String configuration) throws JaguarException {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Features extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class CustomerUpdate extends JaguarObject {
      /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class InvoiceHistory extends JaguarObject {
      /** Whether the feature is enabled. */
      @SerializedName("enabled")
      Boolean enabled;
    }
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class PaymentMethodUpdate extends JaguarObject {
      /** Whether the feature is enabled. */
      @SerializedName("enabled")
      Boolean enabled;
    }
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class SubscriptionCancel extends JaguarObject {
      ...
      @Setter
      @EqualsAndHashCode(callSuper = false)
      public static class CancellationReason extends JaguarObject {
        /** Whether the feature is enabled. */
        @SerializedName("enabled")
        Boolean enabled;
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class SubscriptionPause extends JaguarObject {
      /** Whether the feature is enabled. */
      @SerializedName("enabled")
      Boolean enabled;
    }
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class SubscriptionUpdate extends JaguarObject {
      /**
      ...
      @Setter
      @EqualsAndHashCode(callSuper = false)
      public static class Product extends JaguarObject {
