...
import com.jaguar.param.SubscriptionItemCreateParams;
import com.jaguar.param.SubscriptionItemDeleteParams;
import com.jaguar.param.SubscriptionItemListParams;
import com.jaguar.param.SubscriptionItemRetrieveParams;
import com.jaguar.param.SubscriptionItemUpdateParams;
import com.jaguar.param.SubscriptionItemUsageRecordSummariesParams;
...
public class SubscriptionItem extends ApiResource
  ...
  public static SubscriptionItemCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static SubscriptionItemCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/subscription_items");
  ...
  public static SubscriptionItemCollection list(
      SubscriptionItemListParams params, RequestOptions options) throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/subscription_items");
    return ApiResource.requestCollection(url, params, SubscriptionItemCollection.class, options);
  }

  /** Retrieves the subscription item with the given ID. */
  public static SubscriptionItem retrieve(String item) throws JaguarException {
  ...
  public static SubscriptionItem retrieve(
      String item, Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  public static SubscriptionItem create(Map<String, Object> params) throws JaguarException {
  ...
  @Override
  public SubscriptionItem update(Map<String, Object> params) throws JaguarException {
  ...
  /** Updates the plan or quantity of an item on a current subscription. */
  public SubscriptionItem update(SubscriptionItemUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   */
  public SubscriptionItem delete() throws JaguarException {
   ...
   * not cancel the subscription.
   */
  public SubscriptionItem delete(RequestOptions options) throws JaguarException {
   ...
   * not cancel the subscription.
   */
  public SubscriptionItem delete(Map<String, Object> params) throws JaguarException {
   ...
   * not cancel the subscription.
   */
  public SubscriptionItem delete(SubscriptionItemDeleteParams params) throws JaguarException {
    return delete(params, (RequestOptions) null);
  }
   ...
   */
  public UsageRecordSummaryCollection usageRecordSummaries() throws JaguarException {
   ...
   */
  public UsageRecordSummaryCollection usageRecordSummaries(
      SubscriptionItemUsageRecordSummariesParams params) throws JaguarException {
    return usageRecordSummaries(params, (RequestOptions) null);
  }
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class BillingThresholds extends JaguarObject {
