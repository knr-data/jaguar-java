...
import com.jaguar.param.SubscriptionCancelParams;
import com.jaguar.param.SubscriptionCreateParams;
import com.jaguar.param.SubscriptionListParams;
import com.jaguar.param.SubscriptionRetrieveParams;
import com.jaguar.param.SubscriptionUpdateParams;
...
public class Subscription extends ApiResource implements HasId, MetadataStore<Subscription> {
   ...
   */
  public static SubscriptionCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static SubscriptionCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/subscriptions");
   ...
   * canceled subscriptions, specify <code>status=canceled</code>.
   */
  public static SubscriptionCollection list(SubscriptionListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   */
  public static Subscription create(Map<String, Object> params) throws JaguarException {
   ...
   * scheduled subscriptions.
   */
  public static Subscription create(SubscriptionCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
   ...
   */
  @Override
  public Subscription update(Map<String, Object> params) throws JaguarException {
   ...
   * href="https://stripe.com/docs/api#upcoming_invoice">upcoming invoice</a> endpoint.
   */
  public Subscription update(SubscriptionUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
  ...
  public static Subscription retrieve(String subscriptionExposedId) throws JaguarException {
   ...
   */
  public Subscription cancel() throws JaguarException {
   ...
   * for unpaid invoices before allowing the customer to cancel the subscription at all.
   */
  public Subscription cancel(Map<String, Object> params) throws JaguarException {
   ...
   * for unpaid invoices before allowing the customer to cancel the subscription at all.
   */
  public Subscription cancel(SubscriptionCancelParams params) throws JaguarException {
    return cancel(params, (RequestOptions) null);
  }
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class PauseCollection extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class PendingInvoiceItemInterval extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class PendingUpdate extends JaguarObject {
    /**
