...
import com.jaguar.param.FileLinkCreateParams;
import com.jaguar.param.FileLinkListParams;
import com.jaguar.param.FileLinkRetrieveParams;
import com.jaguar.param.FileLinkUpdateParams;
...
public class FileLink extends ApiResource implements HasId, MetadataStore<FileLink> {
  ...
  public static FileLink retrieve(String link) throws JaguarException {
    return retrieve(link, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves the file link with the given ID. */
  public static FileLink retrieve(String link, RequestOptions options) throws JaguarException {
  ...
  public static FileLink retrieve(String link, Map<String, Object> params, RequestOptions options)
    ...
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/file_links/%s", ApiResource.urlEncodeId(link)));
  ...
  public static FileLink retrieve(
      String link, FileLinkRetrieveParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/file_links/%s", ApiResource.urlEncodeId(link)));
  ...
  public static FileLink create(Map<String, Object> params) throws JaguarException {
  ...
  public static FileLink create(Map<String, Object> params, RequestOptions options)
      throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/file_links");
    return ApiResource.request(
        ApiResource.RequestMethod.POST, url, params, FileLink.class, options);
  }

  /** Creates a new file link object. */
  public static FileLink create(FileLinkCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  @Override
  public FileLink update(Map<String, Object> params) throws JaguarException {
  ...
  /** Updates an existing file link object. Expired links can no longer be updated. */
  public FileLink update(FileLinkUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
  ...
  public static FileLinkCollection list(Map<String, Object> params) throws JaguarException {
  ...
  /** Returns a list of file links. */
  public static FileLinkCollection list(FileLinkListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
