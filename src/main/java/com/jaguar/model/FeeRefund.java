...
import com.jaguar.param.FeeRefundUpdateParams;
...
public class FeeRefund extends ApiResource
   ...
   */
  @Override
  public FeeRefund update(Map<String, Object> params) throws JaguarException {
   ...
   * <p>This request only accepts metadata as an argument.
   */
  public FeeRefund update(FeeRefundUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
