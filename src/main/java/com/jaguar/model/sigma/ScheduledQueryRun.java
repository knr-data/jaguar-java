...
import com.jaguar.param.sigma.ScheduledQueryRunListParams;
import com.jaguar.param.sigma.ScheduledQueryRunRetrieveParams;
...
public class ScheduledQueryRun extends ApiResource implements HasId {
  ...
  public static ScheduledQueryRunCollection list(Map<String, Object> params, RequestOptions options)
      throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/sigma/scheduled_query_runs");
  ...
  public static ScheduledQueryRunCollection list(
      ScheduledQueryRunListParams params, RequestOptions options) throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/sigma/scheduled_query_runs");
    return ApiResource.requestCollection(url, params, ScheduledQueryRunCollection.class, options);
  }

  /** Retrieves the details of an scheduled query run. */
  public static ScheduledQueryRun retrieve(String scheduledQueryRun) throws JaguarException {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class RunError extends JaguarObject {
