...
import com.jaguar.param.TopupCancelParams;
import com.jaguar.param.TopupCreateParams;
import com.jaguar.param.TopupListParams;
import com.jaguar.param.TopupRetrieveParams;
import com.jaguar.param.TopupUpdateParams;
...
public class Topup extends ApiResource implements MetadataStore<Topup>, BalanceTransactionSource {
  ...
  public static Topup create(Map<String, Object> params) throws JaguarException {
  ...
  public static Topup create(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/topups");
    return ApiResource.request(ApiResource.RequestMethod.POST, url, params, Topup.class, options);
  }

  /** Top up the balance of an account. */
  public static Topup create(TopupCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  public static TopupCollection list(Map<String, Object> params) throws JaguarException {
  ...
  /** Returns a list of top-ups. */
  public static TopupCollection list(TopupListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   * information.
   */
  public static Topup retrieve(String topup) throws JaguarException {
   ...
   * information.
   */
  public static Topup retrieve(String topup, RequestOptions options) throws JaguarException {
  ...
  public static Topup retrieve(String topup, Map<String, Object> params, RequestOptions options)
    ...
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/topups/%s", ApiResource.urlEncodeId(topup)));
  ...
  @Override
  public Topup update(Map<String, Object> params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }

  /** Updates the metadata of a top-up. Other top-up details are not editable by design. */
  @Override
  public Topup update(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  /** Updates the metadata of a top-up. Other top-up details are not editable by design. */
  public Topup update(TopupUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }

  /** Updates the metadata of a top-up. Other top-up details are not editable by design. */
  public Topup update(TopupUpdateParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  public Topup cancel() throws JaguarException {
    return cancel((Map<String, Object>) null, (RequestOptions) null);
  }

  /** Cancels a top-up. Only pending top-ups can be canceled. */
  public Topup cancel(RequestOptions options) throws JaguarException {
    return cancel((Map<String, Object>) null, options);
  }

  /** Cancels a top-up. Only pending top-ups can be canceled. */
  public Topup cancel(Map<String, Object> params) throws JaguarException {
    return cancel(params, (RequestOptions) null);
  }

  /** Cancels a top-up. Only pending top-ups can be canceled. */
  public Topup cancel(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  /** Cancels a top-up. Only pending top-ups can be canceled. */
  public Topup cancel(TopupCancelParams params) throws JaguarException {
    return cancel(params, (RequestOptions) null);
  }

  /** Cancels a top-up. Only pending top-ups can be canceled. */
  public Topup cancel(TopupCancelParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
