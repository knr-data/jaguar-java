...
import com.jaguar.param.QuoteAcceptParams;
import com.jaguar.param.QuoteCancelParams;
import com.jaguar.param.QuoteCreateParams;
import com.jaguar.param.QuoteFinalizeQuoteParams;
import com.jaguar.param.QuoteListComputedUpfrontLineItemsParams;
import com.jaguar.param.QuoteListLineItemsParams;
import com.jaguar.param.QuoteListParams;
import com.jaguar.param.QuotePdfParams;
import com.jaguar.param.QuoteRetrieveParams;
import com.jaguar.param.QuoteUpdateParams;
...
public class Quote extends ApiResource implements HasId, MetadataStore<Quote> {
  ...
  public static Quote retrieve(String quote) throws JaguarException {
    return retrieve(quote, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves the quote with the given ID. */
  public static Quote retrieve(String quote, RequestOptions options) throws JaguarException {
  ...
  public static Quote retrieve(String quote, Map<String, Object> params, RequestOptions options)
    ...
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/quotes/%s", ApiResource.urlEncodeId(quote)));
   ...
   * template</a>.
   */
  public static Quote create(Map<String, Object> params) throws JaguarException {
  ...
  public static Quote create(Map<String, Object> params, RequestOptions options)
      throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/quotes");
   ...
   * template</a>.
   */
  public static Quote create(QuoteCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  @Override
  public Quote update(Map<String, Object> params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }

  /** A quote models prices and services for a customer. */
  @Override
  public Quote update(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  /** A quote models prices and services for a customer. */
  public Quote update(QuoteUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }

  /** A quote models prices and services for a customer. */
  public Quote update(QuoteUpdateParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  /** Cancels the quote. */
  public Quote cancel() throws JaguarException {
    return cancel((Map<String, Object>) null, (RequestOptions) null);
  }

  /** Cancels the quote. */
  public Quote cancel(RequestOptions options) throws JaguarException {
    return cancel((Map<String, Object>) null, options);
  }

  /** Cancels the quote. */
  public Quote cancel(Map<String, Object> params) throws JaguarException {
    return cancel(params, (RequestOptions) null);
  }

  /** Cancels the quote. */
  public Quote cancel(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  /** Cancels the quote. */
  public Quote cancel(QuoteCancelParams params) throws JaguarException {
    return cancel(params, (RequestOptions) null);
  }

  /** Cancels the quote. */
  public Quote cancel(QuoteCancelParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  /** Finalizes the quote. */
  public Quote finalizeQuote() throws JaguarException {
    return finalizeQuote((Map<String, Object>) null, (RequestOptions) null);
  }

  /** Finalizes the quote. */
  public Quote finalizeQuote(RequestOptions options) throws JaguarException {
    return finalizeQuote((Map<String, Object>) null, options);
  }

  /** Finalizes the quote. */
  public Quote finalizeQuote(Map<String, Object> params) throws JaguarException {
  ...
  /** Finalizes the quote. */
  public Quote finalizeQuote(QuoteFinalizeQuoteParams params) throws JaguarException {
    return finalizeQuote(params, (RequestOptions) null);
  }
  ...
  public Quote accept() throws JaguarException {
    return accept((Map<String, Object>) null, (RequestOptions) null);
  }

  /** Accepts the specified quote. */
  public Quote accept(RequestOptions options) throws JaguarException {
    return accept((Map<String, Object>) null, options);
  }

  /** Accepts the specified quote. */
  public Quote accept(Map<String, Object> params) throws JaguarException {
    return accept(params, (RequestOptions) null);
  }

  /** Accepts the specified quote. */
  public Quote accept(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  /** Accepts the specified quote. */
  public Quote accept(QuoteAcceptParams params) throws JaguarException {
    return accept(params, (RequestOptions) null);
  }

  /** Accepts the specified quote. */
  public Quote accept(QuoteAcceptParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  public static QuoteCollection list(Map<String, Object> params) throws JaguarException {
  ...
  /** Returns a list of your quotes. */
  public static QuoteCollection list(QuoteListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   */
  public LineItemCollection listLineItems() throws JaguarException {
   ...
   * (paginated) list of line items.
   */
  public LineItemCollection listLineItems(Map<String, Object> params) throws JaguarException {
   ...
   * (paginated) list of line items.
   */
  public LineItemCollection listLineItems(QuoteListLineItemsParams params) throws JaguarException {
    return listLineItems(params, (RequestOptions) null);
  }
   ...
   */
  public LineItemCollection listComputedUpfrontLineItems() throws JaguarException {
   ...
   */
  public LineItemCollection listComputedUpfrontLineItems(
      QuoteListComputedUpfrontLineItemsParams params) throws JaguarException {
    return listComputedUpfrontLineItems(params, (RequestOptions) null);
  }
  ...
  /** Download the PDF for a finalized quote. */
  public InputStream pdf(Map<String, Object> params) throws JaguarException {
  ...
  /** Download the PDF for a finalized quote. */
  public InputStream pdf(QuotePdfParams params) throws JaguarException {
    return pdf(params, (RequestOptions) null);
  }

  /** Download the PDF for a finalized quote. */
  public InputStream pdf(QuotePdfParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getUploadBase(),
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Computed extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class FromQuote extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class InvoiceSettings extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Recurring extends JaguarObject {
    /** Total before any discounts or taxes are applied. */
    @SerializedName("amount_subtotal")
    Long amountSubtotal;
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class SubscriptionData extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class TotalDetails extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Breakdown extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Upfront extends JaguarObject {
    /** Total before any discounts or taxes are applied. */
    @SerializedName("amount_subtotal")
    Long amountSubtotal;
