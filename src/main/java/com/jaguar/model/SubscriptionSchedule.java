...
import com.jaguar.param.SubscriptionScheduleCancelParams;
import com.jaguar.param.SubscriptionScheduleCreateParams;
import com.jaguar.param.SubscriptionScheduleListParams;
import com.jaguar.param.SubscriptionScheduleReleaseParams;
import com.jaguar.param.SubscriptionScheduleRetrieveParams;
import com.jaguar.param.SubscriptionScheduleUpdateParams;
...
public class SubscriptionSchedule extends ApiResource
  ...
  public static SubscriptionScheduleCollection list(
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/subscription_schedules");
  ...
  /** Retrieves the list of your subscription schedules. */
  public static SubscriptionScheduleCollection list(
      SubscriptionScheduleListParams params, RequestOptions options) throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/subscription_schedules");
    return ApiResource.requestCollection(
        url, params, SubscriptionScheduleCollection.class, options);
  }
   ...
   */
  public static SubscriptionSchedule create(Map<String, Object> params) throws JaguarException {
  ...
  public static SubscriptionSchedule create(
      SubscriptionScheduleCreateParams params, RequestOptions options) throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/subscription_schedules");
    return ApiResource.request(
        ApiResource.RequestMethod.POST, url, params, SubscriptionSchedule.class, options);
  }
   ...
   */
  public static SubscriptionSchedule retrieve(String schedule) throws JaguarException {
  ...
  public static SubscriptionSchedule retrieve(
      String schedule, Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  @Override
  public SubscriptionSchedule update(Map<String, Object> params) throws JaguarException {
  ...
  public SubscriptionSchedule update(
      SubscriptionScheduleUpdateParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  public SubscriptionSchedule cancel() throws JaguarException {
   ...
   * if its status is <code>not_started</code> or <code>active</code>.
   */
  public SubscriptionSchedule cancel(RequestOptions options) throws JaguarException {
   ...
   * if its status is <code>not_started</code> or <code>active</code>.
   */
  public SubscriptionSchedule cancel(Map<String, Object> params) throws JaguarException {
  ...
  public SubscriptionSchedule cancel(
      SubscriptionScheduleCancelParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  public SubscriptionSchedule release() throws JaguarException {
   ...
   * and set the subscription’s ID to the <code>released_subscription</code> property.
   */
  public SubscriptionSchedule release(RequestOptions options) throws JaguarException {
   ...
   * and set the subscription’s ID to the <code>released_subscription</code> property.
   */
  public SubscriptionSchedule release(Map<String, Object> params) throws JaguarException {
  ...
  public SubscriptionSchedule release(
      SubscriptionScheduleReleaseParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class AddInvoiceItem extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class CurrentPhase extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class DefaultSettings extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Phase extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class PhaseItem extends JaguarObject {
    /**
