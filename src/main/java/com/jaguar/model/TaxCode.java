...
import com.jaguar.param.TaxCodeListParams;
import com.jaguar.param.TaxCodeRetrieveParams;
...
public class TaxCode extends ApiResource implements HasId {
   ...
   */
  public static TaxCodeCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static TaxCodeCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/tax_codes");
   ...
   * Products in order to allow specific tax calculations.
   */
  public static TaxCodeCollection list(TaxCodeListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   */
  public static TaxCode retrieve(String id) throws JaguarException {
   ...
   * return the corresponding tax code information.
   */
  public static TaxCode retrieve(String id, RequestOptions options) throws JaguarException {
  ...
  public static TaxCode retrieve(String id, Map<String, Object> params, RequestOptions options)
    ...
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/tax_codes/%s", ApiResource.urlEncodeId(id)));
