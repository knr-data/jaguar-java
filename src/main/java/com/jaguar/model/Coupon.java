...
import com.jaguar.param.CouponCreateParams;
import com.jaguar.param.CouponListParams;
import com.jaguar.param.CouponRetrieveParams;
import com.jaguar.param.CouponUpdateParams;
...
public class Coupon extends ApiResource implements HasId, MetadataStore<Coupon> {
  ...
  public static CouponCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static CouponCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/coupons");
    return ApiResource.requestCollection(url, params, CouponCollection.class, options);
  }

  /** Returns a list of your coupons. */
  public static CouponCollection list(CouponListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   */
  public static Coupon create(Map<String, Object> params) throws JaguarException {
   ...
   * 200 is applied to it.
   */
  public static Coupon create(CouponCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  public static Coupon retrieve(String coupon) throws JaguarException {
    return retrieve(coupon, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves the coupon with the given ID. */
  public static Coupon retrieve(String coupon, RequestOptions options) throws JaguarException {
  ...
  public static Coupon retrieve(String coupon, Map<String, Object> params, RequestOptions options)
    ...
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/coupons/%s", ApiResource.urlEncodeId(coupon)));
   ...
   */
  @Override
  public Coupon update(Map<String, Object> params) throws JaguarException {
   ...
   */
  @Override
  public Coupon update(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * design, not editable.
   */
  public Coupon update(CouponUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   * design, not editable.
   */
  public Coupon update(CouponUpdateParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  public Coupon delete() throws JaguarException {
   ...
   * coupon. You can also delete coupons via the API.
   */
  public Coupon delete(RequestOptions options) throws JaguarException {
   ...
   * coupon. You can also delete coupons via the API.
   */
  public Coupon delete(Map<String, Object> params) throws JaguarException {
   ...
   * coupon. You can also delete coupons via the API.
   */
  public Coupon delete(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class AppliesTo extends JaguarObject {
