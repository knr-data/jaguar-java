...
import com.jaguar.param.RefundCreateParams;
import com.jaguar.param.RefundListParams;
import com.jaguar.param.RefundRetrieveParams;
import com.jaguar.param.RefundUpdateParams;
...
public class Refund extends ApiResource implements MetadataStore<Refund>, BalanceTransactionSource {
   ...
   */
  public static RefundCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static RefundCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/refunds");
   ...
   * refunds are always available by default on the charge object.
   */
  public static RefundCollection list(RefundListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
  ...
  /** Create a refund. */
  public static Refund create(Map<String, Object> params) throws JaguarException {
  ...
  /** Create a refund. */
  public static Refund create(RefundCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  public static Refund retrieve(String refund) throws JaguarException {
    return retrieve(refund, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves the details of an existing refund. */
  public static Refund retrieve(String refund, RequestOptions options) throws JaguarException {
  ...
  public static Refund retrieve(String refund, Map<String, Object> params, RequestOptions options)
    ...
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/refunds/%s", ApiResource.urlEncodeId(refund)));
   ...
   */
  @Override
  public Refund update(Map<String, Object> params) throws JaguarException {
   ...
   */
  @Override
  public Refund update(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * <p>This request only accepts <code>metadata</code> as an argument.
   */
  public Refund update(RefundUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   * <p>This request only accepts <code>metadata</code> as an argument.
   */
  public Refund update(RefundUpdateParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
