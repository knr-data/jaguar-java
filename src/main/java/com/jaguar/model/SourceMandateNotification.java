...
public class SourceMandateNotification extends JaguarObject implements HasId {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class AcssDebitData extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class BacsDebitData extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class SepaDebitData extends JaguarObject {
    /** SEPA creditor ID. */
