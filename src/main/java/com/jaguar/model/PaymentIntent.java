...
import com.jaguar.param.PaymentIntentCancelParams;
import com.jaguar.param.PaymentIntentCaptureParams;
import com.jaguar.param.PaymentIntentConfirmParams;
import com.jaguar.param.PaymentIntentCreateParams;
import com.jaguar.param.PaymentIntentListParams;
import com.jaguar.param.PaymentIntentRetrieveParams;
import com.jaguar.param.PaymentIntentUpdateParams;
...
public class PaymentIntent extends ApiResource implements HasId, MetadataStore<PaymentIntent> {
   ...
   */
  public static PaymentIntent create(Map<String, Object> params) throws JaguarException {
  ...
  public static PaymentIntent create(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/payment_intents");
   ...
   * confirm=true</code> is supplied.
   */
  public static PaymentIntent create(PaymentIntentCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  public static PaymentIntentCollection list(Map<String, Object> params) throws JaguarException {
   ...
   */
  public static PaymentIntent retrieve(String intent) throws JaguarException {
  ...
  public static PaymentIntent retrieve(
      String intent, Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  @Override
  public PaymentIntent update(Map<String, Object> params) throws JaguarException {
   ...
   * href="https://stripe.com/docs/api/payment_intents/confirm">confirm API</a> instead.
   */
  public PaymentIntent update(PaymentIntentUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   */
  public PaymentIntent confirm() throws JaguarException {
   ...
   * to learn more about manual confirmation.
   */
  public PaymentIntent confirm(RequestOptions options) throws JaguarException {
   ...
   * to learn more about manual confirmation.
   */
  public PaymentIntent confirm(Map<String, Object> params) throws JaguarException {
   ...
   * to learn more about manual confirmation.
   */
  public PaymentIntent confirm(PaymentIntentConfirmParams params) throws JaguarException {
    return confirm(params, (RequestOptions) null);
  }
   ...
   */
  public PaymentIntent cancel() throws JaguarException {
   ...
   * automatically be refunded.
   */
  public PaymentIntent cancel(RequestOptions options) throws JaguarException {
   ...
   * automatically be refunded.
   */
  public PaymentIntent cancel(Map<String, Object> params) throws JaguarException {
   ...
   * automatically be refunded.
   */
  public PaymentIntent cancel(PaymentIntentCancelParams params) throws JaguarException {
    return cancel(params, (RequestOptions) null);
  }
   ...
   */
  public PaymentIntent capture() throws JaguarException {
   ...
   * authorization and capture</a>.
   */
  public PaymentIntent capture(RequestOptions options) throws JaguarException {
   ...
   * authorization and capture</a>.
   */
  public PaymentIntent capture(Map<String, Object> params) throws JaguarException {
   ...
   * authorization and capture</a>.
   */
  public PaymentIntent capture(PaymentIntentCaptureParams params) throws JaguarException {
    return capture(params, (RequestOptions) null);
  }
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class NextAction extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class VerifyWithMicrodeposits extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class WechatPayDisplayQrCode extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class WechatPayRedirectToAndroidApp extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class WechatPayRedirectToIosApp extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class NextActionAlipayHandleRedirect extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class NextActionDisplayBoletoDetails extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class NextActionOxxoDisplayDetails extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class NextActionRedirectToUrl extends JaguarObject {
    /**
     * If the customer does not exit their browser while authenticating, they will be redirected to
     * this specified URL after completion.
     */
  ...
  public static class PaymentMethodOptions extends JaguarObject {
    ...
    public static class Card extends JaguarObject {
      ...
      public static class Installments extends JaguarObject {
        ...
        @Setter
        @EqualsAndHashCode(callSuper = false)
        public static class Plan extends JaguarObject {
          /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class SepaDebitMandateOptions extends JaguarObject {}
