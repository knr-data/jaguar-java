...
import com.jaguar.param.issuing.CardCreateParams;
import com.jaguar.param.issuing.CardListParams;
import com.jaguar.param.issuing.CardRetrieveParams;
import com.jaguar.param.issuing.CardUpdateParams;
...
public class Card extends ApiResource implements HasId, MetadataStore<Card> {
   ...
   */
  public static CardCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static CardCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/issuing/cards");
   ...
   * by creation date, with the most recently created object appearing first.
   */
  public static CardCollection list(CardListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
  ...
  public static Card create(Map<String, Object> params) throws JaguarException {
  ...
  /** Creates an Issuing <code>Card</code> object. */
  public static Card create(CardCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  public static Card retrieve(String card) throws JaguarException {
    return retrieve(card, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves an Issuing <code>Card</code> object. */
  public static Card retrieve(String card, RequestOptions options) throws JaguarException {
   ...
   */
  @Override
  public Card update(Map<String, Object> params) throws JaguarException {
   ...
   */
  @Override
  public Card update(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * passed. Any parameters not provided will be left unchanged.
   */
  public Card update(CardUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   * passed. Any parameters not provided will be left unchanged.
   */
  public Card update(CardUpdateParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Shipping extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class SpendingControls extends JaguarObject {
    /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class SpendingLimit extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Wallets extends JaguarObject {
