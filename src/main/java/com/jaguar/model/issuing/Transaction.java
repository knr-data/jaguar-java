...
import com.jaguar.param.issuing.TransactionListParams;
import com.jaguar.param.issuing.TransactionRetrieveParams;
import com.jaguar.param.issuing.TransactionUpdateParams;
...
public class Transaction extends ApiResource
   ...
   */
  public static TransactionCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static TransactionCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/issuing/transactions");
   ...
   * descending order by creation date, with the most recently created object appearing first.
   */
  public static TransactionCollection list(TransactionListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
  ...
  public static Transaction retrieve(String transaction) throws JaguarException {
   ...
   */
  @Override
  public Transaction update(Map<String, Object> params) throws JaguarException {
   ...
   * parameters passed. Any parameters not provided will be left unchanged.
   */
  public Transaction update(TransactionUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class PurchaseDetails extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Flight extends JaguarObject {
      ...
      @Setter
      @EqualsAndHashCode(callSuper = false)
      public static class Segments extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Fuel extends JaguarObject {
      /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Lodging extends JaguarObject {
