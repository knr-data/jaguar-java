...
import com.jaguar.model.BalanceTransactionSource;
...
import com.jaguar.param.issuing.DisputeCreateParams;
import com.jaguar.param.issuing.DisputeListParams;
import com.jaguar.param.issuing.DisputeRetrieveParams;
import com.jaguar.param.issuing.DisputeSubmitParams;
import com.jaguar.param.issuing.DisputeUpdateParams;
...
public class Dispute extends ApiResource
   ...
   */
  public static DisputeCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static DisputeCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/issuing/disputes");
   ...
   * order by creation date, with the most recently created object appearing first.
   */
  public static DisputeCollection list(DisputeListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   */
  public static Dispute create(Map<String, Object> params) throws JaguarException {
   ...
   * reasons and evidence</a> for more details about evidence requirements.
   */
  public static Dispute create(DisputeCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
   ...
   */
  @Override
  public Dispute update(Map<String, Object> params) throws JaguarException {
   ...
   */
  @Override
  public Dispute update(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * evidence</code> object can be unset by passing in an empty string.
   */
  public Dispute update(DisputeUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   * evidence</code> object can be unset by passing in an empty string.
   */
  public Dispute update(DisputeUpdateParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  public static Dispute retrieve(String dispute) throws JaguarException {
    return retrieve(dispute, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves an Issuing <code>Dispute</code> object. */
  public static Dispute retrieve(String dispute, RequestOptions options) throws JaguarException {
  ...
  public static Dispute retrieve(
      String dispute, DisputeRetrieveParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  public Dispute submit() throws JaguarException {
   ...
   * reasons and evidence</a>.
   */
  public Dispute submit(RequestOptions options) throws JaguarException {
   ...
   * reasons and evidence</a>.
   */
  public Dispute submit(Map<String, Object> params) throws JaguarException {
   ...
   * reasons and evidence</a>.
   */
  public Dispute submit(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * reasons and evidence</a>.
   */
  public Dispute submit(DisputeSubmitParams params) throws JaguarException {
    return submit(params, (RequestOptions) null);
  }
   ...
   * reasons and evidence</a>.
   */
  public Dispute submit(DisputeSubmitParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Evidence extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Canceled extends JaguarObject {
      /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Duplicate extends JaguarObject {
      /**
       * (ID of a <a href="https://stripe.com/docs/guides/file-upload">file upload</a>) Additional
       * documentation supporting the dispute.
       */
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Fraudulent extends JaguarObject {
      /**
       * (ID of a <a href="https://stripe.com/docs/guides/file-upload">file upload</a>) Additional
       * documentation supporting the dispute.
       */
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class MerchandiseNotAsDescribed extends JaguarObject {
      /**
       * (ID of a <a href="https://stripe.com/docs/guides/file-upload">file upload</a>) Additional
       * documentation supporting the dispute.
       */
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class NotReceived extends JaguarObject {
      /**
       * (ID of a <a href="https://stripe.com/docs/guides/file-upload">file upload</a>) Additional
       * documentation supporting the dispute.
       */
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Other extends JaguarObject {
      /**
       * (ID of a <a href="https://stripe.com/docs/guides/file-upload">file upload</a>) Additional
       * documentation supporting the dispute.
       */
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class ServiceNotAsDescribed extends JaguarObject {
      /**
       * (ID of a <a href="https://stripe.com/docs/guides/file-upload">file upload</a>) Additional
       * documentation supporting the dispute.
       */
