...
import com.jaguar.param.issuing.AuthorizationApproveParams;
import com.jaguar.param.issuing.AuthorizationDeclineParams;
import com.jaguar.param.issuing.AuthorizationListParams;
import com.jaguar.param.issuing.AuthorizationRetrieveParams;
import com.jaguar.param.issuing.AuthorizationUpdateParams;
...
public class Authorization extends ApiResource
   ...
   */
  public static AuthorizationCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static AuthorizationCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/issuing/authorizations");
  ...
  public static Authorization retrieve(String authorization) throws JaguarException {
   ...
   */
  @Override
  public Authorization update(Map<String, Object> params) throws JaguarException {
   ...
   * parameters passed. Any parameters not provided will be left unchanged.
   */
  public Authorization update(AuthorizationUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   */
  public Authorization approve() throws JaguarException {
   ...
   * authorization</a> flow.
   */
  public Authorization approve(RequestOptions options) throws JaguarException {
   ...
   * authorization</a> flow.
   */
  public Authorization approve(Map<String, Object> params) throws JaguarException {
   ...
   * authorization</a> flow.
   */
  public Authorization approve(AuthorizationApproveParams params) throws JaguarException {
    return approve(params, (RequestOptions) null);
  }
   ...
   * authorization</a> flow.
   */
  public Authorization decline() throws JaguarException {
   ...
   * authorization</a> flow.
   */
  public Authorization decline(RequestOptions options) throws JaguarException {
   ...
   * authorization</a> flow.
   */
  public Authorization decline(Map<String, Object> params) throws JaguarException {
   ...
   * authorization</a> flow.
   */
  public Authorization decline(AuthorizationDeclineParams params) throws JaguarException {
    return decline(params, (RequestOptions) null);
  }
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class AmountDetails extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class MerchantData extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class PendingRequest extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class RequestHistory extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class VerificationData extends JaguarObject {
    /**
