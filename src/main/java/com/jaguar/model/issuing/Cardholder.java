...
import com.jaguar.param.issuing.CardholderCreateParams;
import com.jaguar.param.issuing.CardholderListParams;
import com.jaguar.param.issuing.CardholderRetrieveParams;
import com.jaguar.param.issuing.CardholderUpdateParams;
...
public class Cardholder extends ApiResource implements HasId, MetadataStore<Cardholder> {
   ...
   */
  public static CardholderCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static CardholderCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/issuing/cardholders");
   ...
   * order by creation date, with the most recently created object appearing first.
   */
  public static CardholderCollection list(CardholderListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
  ...
  public static Cardholder create(Map<String, Object> params) throws JaguarException {
  ...
  /** Creates a new Issuing <code>Cardholder</code> object that can be issued cards. */
  public static Cardholder create(CardholderCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  public static Cardholder retrieve(String cardholder) throws JaguarException {
   ...
   */
  @Override
  public Cardholder update(Map<String, Object> params) throws JaguarException {
   ...
   * parameters passed. Any parameters not provided will be left unchanged.
   */
  public Cardholder update(CardholderUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Billing extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Individual extends JaguarObject {
