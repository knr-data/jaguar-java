...
import com.jaguar.param.PriceCreateParams;
import com.jaguar.param.PriceListParams;
import com.jaguar.param.PriceRetrieveParams;
import com.jaguar.param.PriceUpdateParams;
...
public class Price extends ApiResource implements HasId, MetadataStore<Price> {
  ...
  public static PriceCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static PriceCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/prices");
    return ApiResource.requestCollection(url, params, PriceCollection.class, options);
  }

  /** Returns a list of your prices. */
  public static PriceCollection list(PriceListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
  ...
  public static Price create(Map<String, Object> params) throws JaguarException {
  ...
  /** Creates a new price for an existing product. The price can be recurring or one-time. */
  public static Price create(PriceCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  public static Price retrieve(String price) throws JaguarException {
    return retrieve(price, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves the price with the given ID. */
  public static Price retrieve(String price, RequestOptions options) throws JaguarException {
  ...
  public static Price retrieve(String price, Map<String, Object> params, RequestOptions options)
    ...
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/prices/%s", ApiResource.urlEncodeId(price)));
   ...
   */
  @Override
  public Price update(Map<String, Object> params) throws JaguarException {
   ...
   */
  @Override
  public Price update(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * provided are left unchanged.
   */
  public Price update(PriceUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   * provided are left unchanged.
   */
  public Price update(PriceUpdateParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class TransformQuantity extends JaguarObject {
