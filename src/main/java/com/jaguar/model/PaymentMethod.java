...
import com.jaguar.param.PaymentMethodAttachParams;
import com.jaguar.param.PaymentMethodCreateParams;
import com.jaguar.param.PaymentMethodDetachParams;
import com.jaguar.param.PaymentMethodListParams;
import com.jaguar.param.PaymentMethodRetrieveParams;
import com.jaguar.param.PaymentMethodUpdateParams;
...
public class PaymentMethod extends ApiResource implements HasId, MetadataStore<PaymentMethod> {
   ...
   */
  public static PaymentMethod create(Map<String, Object> params) throws JaguarException {
  ...
  public static PaymentMethod create(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/payment_methods");
   ...
   * method details ahead of a future payment.
   */
  public static PaymentMethod create(PaymentMethodCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  public static PaymentMethod retrieve(String paymentMethod) throws JaguarException {
  ...
  @Override
  public PaymentMethod update(Map<String, Object> params) throws JaguarException {
  ...
  /** Updates a PaymentMethod object. A PaymentMethod must be attached a customer to be updated. */
  public PaymentMethod update(PaymentMethodUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   * PaymentMethods</a>
   */
  public static PaymentMethodCollection list(Map<String, Object> params) throws JaguarException {
   ...
   * PaymentMethod’s ID.
   */
  public PaymentMethod attach(Map<String, Object> params) throws JaguarException {
   ...
   * PaymentMethod’s ID.
   */
  public PaymentMethod attach(PaymentMethodAttachParams params) throws JaguarException {
    return attach(params, (RequestOptions) null);
  }
  ...
  public PaymentMethod detach() throws JaguarException {
    return detach((Map<String, Object>) null, (RequestOptions) null);
  }

  /** Detaches a PaymentMethod object from a Customer. */
  public PaymentMethod detach(RequestOptions options) throws JaguarException {
    return detach((Map<String, Object>) null, options);
  }

  /** Detaches a PaymentMethod object from a Customer. */
  public PaymentMethod detach(Map<String, Object> params) throws JaguarException {
  ...
  /** Detaches a PaymentMethod object from a Customer. */
  public PaymentMethod detach(PaymentMethodDetachParams params) throws JaguarException {
    return detach(params, (RequestOptions) null);
  }
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class BillingDetails extends JaguarObject {
    /** Billing address. */
  ...
  public static class Card extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Networks extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class ThreeDSecureUsage extends JaguarObject {
  ...
  public static class Klarna extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class DateOfBirth extends JaguarObject {
  ...
  public static class SepaDebit extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class GeneratedFrom extends JaguarObject {
