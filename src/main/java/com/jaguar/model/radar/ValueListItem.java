...
import com.jaguar.param.radar.ValueListItemCreateParams;
import com.jaguar.param.radar.ValueListItemListParams;
import com.jaguar.param.radar.ValueListItemRetrieveParams;
...
public class ValueListItem extends ApiResource implements HasId {
   ...
   */
  public static ValueListItemCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static ValueListItemCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/radar/value_list_items");
  ...
  public static ValueListItem retrieve(String item) throws JaguarException {
    return retrieve(item, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves a <code>ValueListItem</code> object. */
  public static ValueListItem retrieve(String item, RequestOptions options) throws JaguarException {
   ...
   * list.
   */
  public static ValueListItem create(Map<String, Object> params) throws JaguarException {
   ...
   * list.
   */
  public static ValueListItem create(ValueListItemCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  public ValueListItem delete() throws JaguarException {
    return delete((Map<String, Object>) null, (RequestOptions) null);
  }

  /** Deletes a <code>ValueListItem</code> object, removing it from its parent value list. */
  public ValueListItem delete(RequestOptions options) throws JaguarException {
    return delete((Map<String, Object>) null, options);
  }

  /** Deletes a <code>ValueListItem</code> object, removing it from its parent value list. */
  public ValueListItem delete(Map<String, Object> params) throws JaguarException {
