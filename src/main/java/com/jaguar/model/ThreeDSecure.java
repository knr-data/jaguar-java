...
import com.jaguar.param.ThreeDSecureCreateParams;
import com.jaguar.param.ThreeDSecureRetrieveParams;
...
public class ThreeDSecure extends ApiResource implements HasId {
  ...
  public static ThreeDSecure retrieve(String threeDSecure) throws JaguarException {
  ...
  public static ThreeDSecure create(Map<String, Object> params) throws JaguarException {
  ...
  public static ThreeDSecure create(Map<String, Object> params, RequestOptions options)
      throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/3d_secure");
    return ApiResource.request(
        ApiResource.RequestMethod.POST, url, params, ThreeDSecure.class, options);
  }

  /** Initiate 3D Secure authentication. */
  public static ThreeDSecure create(ThreeDSecureCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
