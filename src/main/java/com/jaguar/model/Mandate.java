...
import com.jaguar.param.MandateRetrieveParams;
...
public class Mandate extends ApiResource implements HasId {
  ...
  public static Mandate retrieve(String mandate) throws JaguarException {
    return retrieve(mandate, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves a Mandate object. */
  public static Mandate retrieve(String mandate, RequestOptions options) throws JaguarException {
  ...
  public static Mandate retrieve(
      String mandate, MandateRetrieveParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class CustomerAcceptance extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Offline extends JaguarObject {}

    @Getter
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Online extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class MultiUse extends JaguarObject {}
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class SingleUse extends JaguarObject {
