...
import com.jaguar.param.IssuerFraudRecordListParams;
import com.jaguar.param.IssuerFraudRecordRetrieveParams;
...
public class IssuerFraudRecord extends ApiResource implements HasId {
  ...
  public static IssuerFraudRecordCollection list(Map<String, Object> params, RequestOptions options)
      throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/issuer_fraud_records");
  ...
  public static IssuerFraudRecordCollection list(
      IssuerFraudRecordListParams params, RequestOptions options) throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/issuer_fraud_records");
    return ApiResource.requestCollection(url, params, IssuerFraudRecordCollection.class, options);
  }
   ...
   */
  public static IssuerFraudRecord retrieve(String issuerFraudRecord) throws JaguarException {
