...
import com.jaguar.param.TransferCreateParams;
import com.jaguar.param.TransferListParams;
import com.jaguar.param.TransferRetrieveParams;
import com.jaguar.param.TransferUpdateParams;
...
public class Transfer extends ApiResource
   ...
   */
  public static Transfer create(Map<String, Object> params) throws JaguarException {
  ...
  public static Transfer create(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/transfers");
   ...
   * cover the transfer amount, or you’ll receive an “Insufficient Funds” error.
   */
  public static Transfer create(TransferCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
   ...
   */
  public static TransferCollection list(Map<String, Object> params) throws JaguarException {
   ...
   * sorted order, with the most recently created transfers appearing first.
   */
  public static TransferCollection list(TransferListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   */
  public static Transfer retrieve(String transfer) throws JaguarException {
   ...
   * transfer information.
   */
  public static Transfer retrieve(String transfer, RequestOptions options) throws JaguarException {
  ...
  public static Transfer retrieve(
      String transfer, Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  @Override
  public Transfer update(Map<String, Object> params) throws JaguarException {
   ...
   * <p>This request accepts only metadata as an argument.
   */
  public Transfer update(TransferUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
