...
import com.jaguar.model.radar.Rule;
import com.jaguar.net.ApiResource;
import com.jaguar.net.RequestOptions;
import com.jaguar.param.ChargeCaptureParams;
import com.jaguar.param.ChargeCreateParams;
import com.jaguar.param.ChargeListParams;
import com.jaguar.param.ChargeRetrieveParams;
...
public class Charge extends ApiResource implements MetadataStore<Charge>, BalanceTransactionSource {
   ...
   */
  public static ChargeCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static ChargeCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/charges");
   ...
   * with the most recent charges appearing first.
   */
  public static ChargeCollection list(ChargeListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   */
  public static Charge create(Map<String, Object> params) throws JaguarException {
   ...
   * charge would have completed successfully).
   */
  public static Charge create(ChargeCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
   ...
   */
  public static Charge retrieve(String charge) throws JaguarException {
   ...
   * information. The same information is returned when creating or refunding the charge.
   */
  public static Charge retrieve(String charge, RequestOptions options) throws JaguarException {
  ...
  public static Charge retrieve(String charge, Map<String, Object> params, RequestOptions options)
    ...
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/charges/%s", ApiResource.urlEncodeId(charge)));
   ...
   */
  @Override
  public Charge update(Map<String, Object> params) throws JaguarException {
   ...
   */
  @Override
  public Charge update(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * provided will be left unchanged.
   */
  public Charge update(ChargeUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   * provided will be left unchanged.
   */
  public Charge update(ChargeUpdateParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * capturable.
   */
  public Charge capture() throws JaguarException {
   ...
   * capturable.
   */
  public Charge capture(RequestOptions options) throws JaguarException {
   ...
   * capturable.
   */
  public Charge capture(Map<String, Object> params) throws JaguarException {
   ...
   * capturable.
   */
  public Charge capture(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * capturable.
   */
  public Charge capture(ChargeCaptureParams params) throws JaguarException {
    return capture(params, (RequestOptions) null);
  }
   ...
   * capturable.
   */
  public Charge capture(ChargeCaptureParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class AlternateStatementDescriptors extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class FraudDetails extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Level3 extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class LineItem extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Outcome extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class PaymentMethodDetails extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class AchCreditTransfer extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class AchDebit extends JaguarObject {
      /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class AfterpayClearpay extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Alipay extends JaguarObject {
      /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class AuBecsDebit extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class BacsDebit extends JaguarObject {
      /**
       * Uniquely identifies this particular bank account. You can use this attribute to check
       * whether two bank accounts are the same.
       */
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Boleto extends JaguarObject {
      /**
    ...
    public static class Card extends JaguarObject {
      ...
      @Setter
      @EqualsAndHashCode(callSuper = false)
      public static class Checks extends JaguarObject {
        /**
      ...
      @Setter
      @EqualsAndHashCode(callSuper = false)
      public static class Installments extends JaguarObject {
      ...
      @Setter
      @EqualsAndHashCode(callSuper = false)
      public static class ThreeDSecure extends JaguarObject {
        /**
      ...
      @Setter
      @EqualsAndHashCode(callSuper = false)
      public static class Wallet extends JaguarObject {
        ...
        @Setter
        @EqualsAndHashCode(callSuper = false)
        public static class AmexExpressCheckout extends JaguarObject {}

        @Getter
        @Setter
        @EqualsAndHashCode(callSuper = false)
        public static class ApplePay extends JaguarObject {}

        @Getter
        @Setter
        @EqualsAndHashCode(callSuper = false)
        public static class GooglePay extends JaguarObject {}

        @Getter
        @Setter
        @EqualsAndHashCode(callSuper = false)
        public static class Masterpass extends JaguarObject {
          /**
        ...
        @Setter
        @EqualsAndHashCode(callSuper = false)
        public static class SamsungPay extends JaguarObject {}

        @Getter
        @Setter
        @EqualsAndHashCode(callSuper = false)
        public static class VisaCheckout extends JaguarObject {
          /**
           * Owner's verified billing address. Values are verified or provided by the wallet
           * directly (if supported) at the time of authorization or settlement. They cannot be set
           * or mutated.
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class CardPresent extends JaguarObject {
      ...
      @Setter
      @EqualsAndHashCode(callSuper = false)
      public static class Receipt extends JaguarObject {
        /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Eps extends JaguarObject {
      /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Fpx extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Giropay extends JaguarObject {
      /** Bank code of bank associated with the bank account. */
      @SerializedName("bank_code")
      String bankCode;
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Grabpay extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Ideal extends JaguarObject {
      /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class InteracPresent extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Klarna extends JaguarObject {
      /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Multibanco extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Oxxo extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class P24 extends JaguarObject {
      /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class SepaCreditTransfer extends JaguarObject {
      /** Name of the bank associated with the bank account. */
      @SerializedName("bank_name")
      String bankName;
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class SepaDebit extends JaguarObject {
      /** Bank code of bank associated with the bank account. */
      @SerializedName("bank_code")
      String bankCode;
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Sofort extends JaguarObject {
      /** Bank code of bank associated with the bank account. */
      @SerializedName("bank_code")
      String bankCode;
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class JaguarAccount extends JaguarObject {}

    @Getter
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Wechat extends JaguarObject {}

    @Getter
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class WechatPay extends JaguarObject {
      /**
