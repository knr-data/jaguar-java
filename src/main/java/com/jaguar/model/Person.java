...
import com.jaguar.param.PersonUpdateParams;
...
public class Person extends ApiResource implements HasId, MetadataStore<Person> {
  ...
  @Override
  public Person update(Map<String, Object> params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }

  /** Updates an existing person. */
  @Override
  public Person update(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  /** Updates an existing person. */
  public Person update(PersonUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }

  /** Updates an existing person. */
  public Person update(PersonUpdateParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  public Person delete() throws JaguarException {
   ...
   * cannot delete the only verified <code>executive</code> on file.
   */
  public Person delete(RequestOptions options) throws JaguarException {
   ...
   * cannot delete the only verified <code>executive</code> on file.
   */
  public Person delete(Map<String, Object> params) throws JaguarException {
   ...
   * cannot delete the only verified <code>executive</code> on file.
   */
  public Person delete(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class JapanAddress extends JaguarObject {
    /** City/Ward. */
    @SerializedName("city")
    String city;
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Relationship extends JaguarObject {
    /**
