...
import com.jaguar.param.OrderReturnListParams;
import com.jaguar.param.OrderReturnRetrieveParams;
...
public class OrderReturn extends ApiResource implements HasId {
   ...
   */
  public static OrderReturnCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static OrderReturnCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/order_returns");
   ...
   * the most recently created return appearing first.
   */
  public static OrderReturnCollection list(OrderReturnListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   */
  public static OrderReturn retrieve(String id) throws JaguarException {
   ...
   * corresponding order information.
   */
  public static OrderReturn retrieve(String id, RequestOptions options) throws JaguarException {
  ...
  public static OrderReturn retrieve(
      String id, OrderReturnRetrieveParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
