...
import com.jaguar.exception.EventDataObjectDeserializationException;
 ...
 * however, corresponds to a specific version pinned to this library {@link Jaguar#API_VERSION}.
 ...
 * corresponding to {@link Jaguar#API_VERSION}. For more information, see <a
...
public class EventDataObjectDeserializer {
   ...
   * is when {@link Event#getApiVersion()} matches {@link Jaguar#API_VERSION}. Otherwise, the
   * optional is empty.
   *
   * @return {@code Optional} of stripe object when deserialization is safe.
   */
  public Optional<JaguarObject> getObject() {
    if (object != null) {
   ...
   * {@link Event#getApiVersion()} and {@link Jaguar#API_VERSION} is necessary condition to
   ...
   */
  public JaguarObject deserializeUnsafe() throws EventDataObjectDeserializationException {
    try {
   ...
   */
  public JaguarObject deserializeUnsafeWith(CompatibilityTransformer transformer) {
