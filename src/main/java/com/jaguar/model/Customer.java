...
import com.jaguar.param.CustomerBalanceTransactionsParams;
import com.jaguar.param.CustomerCreateParams;
import com.jaguar.param.CustomerListParams;
import com.jaguar.param.CustomerListPaymentMethodsParams;
import com.jaguar.param.CustomerRetrieveParams;
import com.jaguar.param.CustomerUpdateParams;
...
public class Customer extends ApiResource implements HasId, MetadataStore<Customer> {
   ...
   */
  public static CustomerCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static CustomerCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/customers");
   ...
   * most recent customers appearing first.
   */
  public static CustomerCollection list(CustomerListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
  ...
  public static Customer create(Map<String, Object> params) throws JaguarException {
  ...
  /** Creates a new customer object. */
  public static Customer create(CustomerCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  public static Customer retrieve(String customer) throws JaguarException {
    return retrieve(customer, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves a Customer object. */
  public static Customer retrieve(String customer, RequestOptions options) throws JaguarException {
    return retrieve(customer, (Map<String, Object>) null, options);
  }

  /** Retrieves a Customer object. */
  public static Customer retrieve(
      String customer, Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  @Override
  public Customer update(Map<String, Object> params) throws JaguarException {
   ...
   * <p>This request accepts mostly the same arguments as the customer creation call.
   */
  public Customer update(CustomerUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   */
  public Customer delete() throws JaguarException {
   ...
   * subscriptions on the customer.
   */
  public Customer delete(RequestOptions options) throws JaguarException {
   ...
   * subscriptions on the customer.
   */
  public Customer delete(Map<String, Object> params) throws JaguarException {
  ...
  /** Returns a list of PaymentMethods for a given Customer. */
  public PaymentMethodCollection listPaymentMethods(
      CustomerListPaymentMethodsParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  public CustomerBalanceTransactionCollection balanceTransactions() throws JaguarException {
   ...
   */
  public CustomerBalanceTransactionCollection balanceTransactions(
      CustomerBalanceTransactionsParams params) throws JaguarException {
    return balanceTransactions(params, (RequestOptions) null);
  }
   ...
   */
  public CustomerBalanceTransactionCollection balanceTransactions(
      CustomerBalanceTransactionsParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  public Discount deleteDiscount() throws JaguarException {
    return deleteDiscount((Map<String, Object>) null, (RequestOptions) null);
  }

  /** Removes the currently applied discount on a customer. */
  public Discount deleteDiscount(Map<String, Object> params) throws JaguarException {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Tax extends JaguarObject {
    /**
