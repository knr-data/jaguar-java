...
import com.jaguar.param.CapabilityUpdateParams;
...
public class Capability extends ApiResource implements HasId {
  ...
  public Capability update(Map<String, Object> params) throws JaguarException {
  ...
  /** Updates an existing Account Capability. */
  public Capability update(CapabilityUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
