...
import com.jaguar.param.SetupIntentCancelParams;
import com.jaguar.param.SetupIntentConfirmParams;
import com.jaguar.param.SetupIntentCreateParams;
import com.jaguar.param.SetupIntentListParams;
import com.jaguar.param.SetupIntentRetrieveParams;
import com.jaguar.param.SetupIntentUpdateParams;
...
public class SetupIntent extends ApiResource implements HasId, MetadataStore<SetupIntent> {
   ...
   */
  public static SetupIntent create(Map<String, Object> params) throws JaguarException {
  ...
  public static SetupIntent create(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/setup_intents");
   ...
   * permissions to charge the payment method later.
   */
  public static SetupIntent create(SetupIntentCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  public static SetupIntentCollection list(Map<String, Object> params) throws JaguarException {
  ...
  /** Returns a list of SetupIntents. */
  public static SetupIntentCollection list(SetupIntentListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   */
  public static SetupIntent retrieve(String intent) throws JaguarException {
   ...
   * reference for more details.
   */
  public static SetupIntent retrieve(String intent, RequestOptions options) throws JaguarException {
  ...
  @Override
  public SetupIntent update(Map<String, Object> params) throws JaguarException {
  ...
  /** Updates a SetupIntent object. */
  public SetupIntent update(SetupIntentUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   */
  public SetupIntent confirm() throws JaguarException {
   ...
   * transition to the <code>requires_payment_method</code> status.
   */
  public SetupIntent confirm(RequestOptions options) throws JaguarException {
   ...
   * transition to the <code>requires_payment_method</code> status.
   */
  public SetupIntent confirm(Map<String, Object> params) throws JaguarException {
   ...
   * transition to the <code>requires_payment_method</code> status.
   */
  public SetupIntent confirm(SetupIntentConfirmParams params) throws JaguarException {
    return confirm(params, (RequestOptions) null);
  }
   ...
   * error.
   */
  public SetupIntent cancel() throws JaguarException {
   ...
   * error.
   */
  public SetupIntent cancel(RequestOptions options) throws JaguarException {
   ...
   * error.
   */
  public SetupIntent cancel(Map<String, Object> params) throws JaguarException {
   ...
   * error.
   */
  public SetupIntent cancel(SetupIntentCancelParams params) throws JaguarException {
    return cancel(params, (RequestOptions) null);
  }
