...
import com.jaguar.param.AccountCapabilitiesParams;
import com.jaguar.param.AccountCreateParams;
import com.jaguar.param.AccountListParams;
import com.jaguar.param.AccountPersonsParams;
import com.jaguar.param.AccountRejectParams;
import com.jaguar.param.AccountRetrieveParams;
import com.jaguar.param.AccountUpdateParams;
...
public class Account extends ApiResource implements MetadataStore<Account>, PaymentSource {
  ...
  public static Account retrieve() throws JaguarException {
    return retrieve((Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves the details of an account. */
  public static Account retrieve(RequestOptions options) throws JaguarException {
  ...
  public static Account retrieve(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/account");
  ...
  /** Retrieves the details of an account. */
  public static Account retrieve(String account) throws JaguarException {
    return retrieve(account, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves the details of an account. */
  public static Account retrieve(String account, RequestOptions options) throws JaguarException {
  ...
  public static Account retrieve(
      String account, AccountRetrieveParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  @Override
  public Account update(Map<String, Object> params) throws JaguarException {
   ...
   */
  @Override
  public Account update(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * more about updating accounts.
   */
  public Account update(AccountUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   * more about updating accounts.
   */
  public Account update(AccountUpdateParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * empty.
   */
  public static AccountCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static AccountCollection list(Map<String, Object> params, RequestOptions options)
      throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/accounts");
   ...
   * empty.
   */
  public static AccountCollection list(AccountListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   */
  public static Account create(Map<String, Object> params) throws JaguarException {
   ...
   * href="https://dashboard.stripe.com/account/applications/settings">register your platform</a>.
   */
  public static Account create(AccountCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
   ...
   * settings</a> instead.
   */
  public Account delete() throws JaguarException {
   ...
   * settings</a> instead.
   */
  public Account delete(RequestOptions options) throws JaguarException {
   ...
   * settings</a> instead.
   */
  public Account delete(Map<String, Object> params) throws JaguarException {
   ...
   * settings</a> instead.
   */
  public Account delete(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  public Account reject(Map<String, Object> params) throws JaguarException {
   ...
   * live-mode keys may only be rejected once all balances are zero.
   */
  public Account reject(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * live-mode keys may only be rejected once all balances are zero.
   */
  public Account reject(AccountRejectParams params) throws JaguarException {
    return reject(params, (RequestOptions) null);
  }
   ...
   * live-mode keys may only be rejected once all balances are zero.
   */
  public Account reject(AccountRejectParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  public PersonCollection persons() throws JaguarException {
   ...
   * sorted by creation date, with the most recent people appearing first.
   */
  public PersonCollection persons(Map<String, Object> params) throws JaguarException {
   ...
   * sorted by creation date, with the most recent people appearing first.
   */
  public PersonCollection persons(AccountPersonsParams params) throws JaguarException {
    return persons(params, (RequestOptions) null);
  }
   ...
   */
  public CapabilityCollection capabilities() throws JaguarException {
   ...
   * sorted by creation date, with the most recent capability appearing first.
   */
  public CapabilityCollection capabilities(Map<String, Object> params) throws JaguarException {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class BusinessProfile extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Capabilities extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Company extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class OwnershipDeclaration extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Verification extends JaguarObject {
      ...
      @Setter
      @EqualsAndHashCode(callSuper = false)
      public static class VerificationDocument extends JaguarObject {
        /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Controller extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class DeclineChargeOn extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class FutureRequirements extends JaguarObject {
    /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Alternative extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Errors extends JaguarObject {
      /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class PayoutSchedule extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Requirements extends JaguarObject {
    /**
     * Fields that are due and can be satisfied by providing the corresponding alternative fields
     * instead.
     */
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Settings extends JaguarObject {
    @SerializedName("bacs_debit_payments")
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class BacsDebitPayments extends JaguarObject {
      /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class SepaDebitPayments extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class SettingsCardIssuing extends JaguarObject {
      @SerializedName("tos_acceptance")
      TosAcceptance tosAcceptance;
      ...
      @Setter
      @EqualsAndHashCode(callSuper = false)
      public static class TosAcceptance extends JaguarObject {
        /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class SettingsBranding extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class SettingsCardPayments extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class SettingsDashboard extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class SettingsPayments extends JaguarObject {
    /**
     * The default text that appears on credit card statements when a charge is made. This field
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class SettingsPayouts extends JaguarObject {
    /**
