...
import com.jaguar.param.TransferReversalUpdateParams;
...
public class TransferReversal extends ApiResource
   ...
   */
  @Override
  public TransferReversal update(Map<String, Object> params) throws JaguarException {
   ...
   * <p>This request only accepts metadata and description as arguments.
   */
  public TransferReversal update(TransferReversalUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
