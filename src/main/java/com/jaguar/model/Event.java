...
import com.jaguar.param.EventRetrieveParams;
...
public class Event extends ApiResource implements HasId {
   ...
   * header).
   */
  public static EventCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static EventCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/events");
   ...
   * header).
   */
  public static EventCollection list(EventListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   */
  public static Event retrieve(String id) throws JaguarException {
   ...
   * have received in a webhook.
   */
  public static Event retrieve(String id, RequestOptions options) throws JaguarException {
  ...
  public static Event retrieve(String id, Map<String, Object> params, RequestOptions options)
    ...
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/events/%s", ApiResource.urlEncodeId(id)));
   ...
   * Jaguar#API_VERSION}. For reading from old webhook endpoints or old events with
