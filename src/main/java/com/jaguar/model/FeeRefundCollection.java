...
import com.jaguar.param.FeeRefundCollectionListParams;
import com.jaguar.param.FeeRefundCollectionRetrieveParams;
import java.util.Map;

public class FeeRefundCollection extends JaguarCollection<FeeRefund> {
  /**
   ...
   */
  public FeeRefund create(Map<String, Object> params) throws JaguarException {
   ...
   * money than is left on an application fee.
   */
  public FeeRefund create(FeeRefundCollectionCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
   ...
   */
  public FeeRefundCollection list(Map<String, Object> params) throws JaguarException {
   ...
   * starting_after</code> parameters to page through additional refunds.
   */
  public FeeRefundCollection list(FeeRefundCollectionListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   * fee.
   */
  public FeeRefund retrieve(String id) throws JaguarException {
   ...
   * fee.
   */
  public FeeRefund retrieve(String id, RequestOptions options) throws JaguarException {
