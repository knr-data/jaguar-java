...
import com.jaguar.param.TokenRetrieveParams;
...
public class Token extends ApiResource implements HasId {
  ...
  public static Token retrieve(String token) throws JaguarException {
    return retrieve(token, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves the token with the given ID. */
  public static Token retrieve(String token, RequestOptions options) throws JaguarException {
  ...
  public static Token retrieve(String token, Map<String, Object> params, RequestOptions options)
    ...
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/tokens/%s", ApiResource.urlEncodeId(token)));
   ...
   */
  public static Token create(Map<String, Object> params) throws JaguarException {
  ...
  public static Token create(Map<String, Object> params, RequestOptions options)
      throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/tokens");
   ...
   * attaching it to a <a href="https://stripe.com/docs/api#accounts">Custom account</a>.
   */
  public static Token create(TokenCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
