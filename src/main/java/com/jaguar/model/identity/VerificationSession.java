...
package com.jaguar.model.identity;

import com.google.gson.annotations.SerializedName;
import com.jaguar.Jaguar;
import com.jaguar.exception.JaguarException;
import com.jaguar.model.Address;
...
import com.jaguar.param.identity.VerificationSessionCancelParams;
import com.jaguar.param.identity.VerificationSessionCreateParams;
import com.jaguar.param.identity.VerificationSessionListParams;
import com.jaguar.param.identity.VerificationSessionRedactParams;
import com.jaguar.param.identity.VerificationSessionRetrieveParams;
import com.jaguar.param.identity.VerificationSessionUpdateParams;
...
public class VerificationSession extends ApiResource
   ...
   */
  public static VerificationSession create(Map<String, Object> params) throws JaguarException {
  ...
  public static VerificationSession create(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/identity/verification_sessions");
  ...
  public static VerificationSession create(
      VerificationSessionCreateParams params, RequestOptions options) throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/identity/verification_sessions");
    return ApiResource.request(
        ApiResource.RequestMethod.POST, url, params, VerificationSession.class, options);
  }
   ...
   */
  public static VerificationSession retrieve(String session) throws JaguarException {
  ...
  public static VerificationSession retrieve(
      String session, Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  /** Returns a list of VerificationSessions. */
  public static VerificationSessionCollection list(
      VerificationSessionListParams params, RequestOptions options) throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/identity/verification_sessions");
    return ApiResource.requestCollection(url, params, VerificationSessionCollection.class, options);
  }
   ...
   */
  public VerificationSession cancel() throws JaguarException {
   ...
   * href="https://stripe.com/docs/identity/verification-sessions#cancel">Learn more</a>.
   */
  public VerificationSession cancel(RequestOptions options) throws JaguarException {
   ...
   * href="https://stripe.com/docs/identity/verification-sessions#cancel">Learn more</a>.
   */
  public VerificationSession cancel(Map<String, Object> params) throws JaguarException {
   ...
   * href="https://stripe.com/docs/identity/verification-sessions#cancel">Learn more</a>.
   */
  public VerificationSession cancel(VerificationSessionCancelParams params) throws JaguarException {
    return cancel(params, (RequestOptions) null);
  }
   ...
   */
  public VerificationSession redact() throws JaguarException {
   ...
   * <p><a href="https://stripe.com/docs/identity/verification-sessions#redact">Learn more</a>.
   */
  public VerificationSession redact(RequestOptions options) throws JaguarException {
   ...
   * <p><a href="https://stripe.com/docs/identity/verification-sessions#redact">Learn more</a>.
   */
  public VerificationSession redact(Map<String, Object> params) throws JaguarException {
   ...
   * <p><a href="https://stripe.com/docs/identity/verification-sessions#redact">Learn more</a>.
   */
  public VerificationSession redact(VerificationSessionRedactParams params) throws JaguarException {
    return redact(params, (RequestOptions) null);
  }
   ...
   */
  @Override
  public VerificationSession update(Map<String, Object> params) throws JaguarException {
   ...
   * the verification check and options.
   */
  public VerificationSession update(VerificationSessionUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class LastError extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Options extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Document extends JaguarObject {
      /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class IdNumber extends JaguarObject {}
  }

  @Getter
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Redaction extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class VerifiedOutputs extends JaguarObject {
