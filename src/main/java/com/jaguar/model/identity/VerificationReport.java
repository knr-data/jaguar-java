...
import com.jaguar.param.identity.VerificationReportListParams;
import com.jaguar.param.identity.VerificationReportRetrieveParams;
...
public class VerificationReport extends ApiResource implements HasId {
  ...
  public static VerificationReport retrieve(String report) throws JaguarException {
  ...
  public static VerificationReport retrieve(
      String report, Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  public static VerificationReportCollection list(
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/identity/verification_reports");
  ...
  /** List all verification reports. */
  public static VerificationReportCollection list(
      VerificationReportListParams params, RequestOptions options) throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/identity/verification_reports");
    return ApiResource.requestCollection(url, params, VerificationReportCollection.class, options);
  }
  ...
  public static class Document extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class DocumentCheckError extends JaguarObject {
      /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class ExpirationDate extends JaguarObject {
      /** Numerical day between 1 and 31. */
      @SerializedName("day")
      Long day;
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class IssuedDate extends JaguarObject {
      /** Numerical day between 1 and 31. */
      @SerializedName("day")
      Long day;
  ...
  public static class IdNumber extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class IdNumberCheckError extends JaguarObject {
      /**
       * A short machine-readable string giving the reason for the verification failure.
       *
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Selfie extends JaguarObject {
    /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class SelfieCheckError extends JaguarObject {
      /**
       * A short machine-readable string giving the reason for the verification failure.
       *
