...
import com.jaguar.param.ApplePayDomainCreateParams;
import com.jaguar.param.ApplePayDomainListParams;
import com.jaguar.param.ApplePayDomainRetrieveParams;
...
public class ApplePayDomain extends ApiResource implements HasId {
  ...
  public static ApplePayDomainCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static ApplePayDomainCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/apple_pay/domains");
  ...
  public static ApplePayDomainCollection list(
      ApplePayDomainListParams params, RequestOptions options) throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/apple_pay/domains");
    return ApiResource.requestCollection(url, params, ApplePayDomainCollection.class, options);
  }

  /** Create an apple pay domain. */
  public static ApplePayDomain create(Map<String, Object> params) throws JaguarException {
  ...
  /** Create an apple pay domain. */
  public static ApplePayDomain create(ApplePayDomainCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  public static ApplePayDomain retrieve(String domain) throws JaguarException {
  ...
  public static ApplePayDomain retrieve(
      String domain, Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  public ApplePayDomain delete() throws JaguarException {
    return delete((Map<String, Object>) null, (RequestOptions) null);
  }

  /** Delete an apple pay domain. */
  public ApplePayDomain delete(RequestOptions options) throws JaguarException {
    return delete((Map<String, Object>) null, options);
  }

  /** Delete an apple pay domain. */
  public ApplePayDomain delete(Map<String, Object> params) throws JaguarException {
