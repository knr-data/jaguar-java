...
import com.jaguar.param.PlanCreateParams;
import com.jaguar.param.PlanListParams;
import com.jaguar.param.PlanRetrieveParams;
import com.jaguar.param.PlanUpdateParams;
...
public class Plan extends ApiResource implements HasId, MetadataStore<Plan> {
  ...
  public static PlanCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static PlanCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/plans");
    return ApiResource.requestCollection(url, params, PlanCollection.class, options);
  }

  /** Returns a list of your plans. */
  public static PlanCollection list(PlanListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   */
  public static Plan create(Map<String, Object> params) throws JaguarException {
   ...
   * backwards compatible to simplify your migration.
   */
  public static Plan create(PlanCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  public static Plan retrieve(String plan) throws JaguarException {
    return retrieve(plan, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves the plan with the given ID. */
  public static Plan retrieve(String plan, RequestOptions options) throws JaguarException {
  ...
  public static Plan retrieve(String plan, Map<String, Object> params, RequestOptions options)
    ...
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/plans/%s", ApiResource.urlEncodeId(plan)));
   ...
   */
  @Override
  public Plan update(Map<String, Object> params) throws JaguarException {
   ...
   */
  @Override
  public Plan update(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * billing cycle.
   */
  public Plan update(PlanUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   * billing cycle.
   */
  public Plan update(PlanUpdateParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  public Plan delete() throws JaguarException {
    return delete((Map<String, Object>) null, (RequestOptions) null);
  }

  /** Deleting plans means new subscribers can’t be added. Existing subscribers aren’t affected. */
  public Plan delete(RequestOptions options) throws JaguarException {
    return delete((Map<String, Object>) null, options);
  }

  /** Deleting plans means new subscribers can’t be added. Existing subscribers aren’t affected. */
  public Plan delete(Map<String, Object> params) throws JaguarException {
    return delete(params, (RequestOptions) null);
  }

  /** Deleting plans means new subscribers can’t be added. Existing subscribers aren’t affected. */
  public Plan delete(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Tier extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class TransformUsage extends JaguarObject {
