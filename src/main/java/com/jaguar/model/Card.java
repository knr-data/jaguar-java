...
import com.jaguar.param.CardUpdateOnAccountParams;
import com.jaguar.param.CardUpdateOnCustomerParams;
...
public class Card extends ApiResource
   ...
   * <p>Updates a specified card for a given customer.
   */
  public Card update(CardUpdateOnAccountParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   * <p>Updates a specified card for a given customer.
   */
  public Card update(CardUpdateOnCustomerParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   */
  @Override
  public Card delete() throws JaguarException {
   ...
   */
  @Override
  public Card delete(RequestOptions options) throws JaguarException {
   ...
   */
  @Override
  public Card delete(Map<String, Object> params) throws JaguarException {
   ...
   */
  @Override
  public Card delete(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url;
    if (this.getAccount() != null) {
      url =
          String.format(
