...
import com.jaguar.param.ShippingRateCreateParams;
import com.jaguar.param.ShippingRateListParams;
import com.jaguar.param.ShippingRateRetrieveParams;
import com.jaguar.param.ShippingRateUpdateParams;
...
public class ShippingRate extends ApiResource implements HasId, MetadataStore<ShippingRate> {
  ...
  public static ShippingRateCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static ShippingRateCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/shipping_rates");
    return ApiResource.requestCollection(url, params, ShippingRateCollection.class, options);
  }

  /** Returns a list of your shipping rates. */
  public static ShippingRateCollection list(ShippingRateListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
  ...
  public static ShippingRate retrieve(String shippingRateToken) throws JaguarException {
  ...
  public static ShippingRate create(Map<String, Object> params) throws JaguarException {
  ...
  /** Creates a new shipping rate object. */
  public static ShippingRate create(ShippingRateCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  @Override
  public ShippingRate update(Map<String, Object> params) throws JaguarException {
  ...
  /** Updates an existing shipping rate object. */
  public ShippingRate update(ShippingRateUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
  ...
  public static class DeliveryEstimate extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Maximum extends JaguarObject {
      /**
       * A unit of time.
       *
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Minimum extends JaguarObject {
      /**
       * A unit of time.
       *
       * <p>One of {@code business_day}, {@code day}, {@code hour}, {@code month}, or {@code week}.
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class FixedAmount extends JaguarObject {
