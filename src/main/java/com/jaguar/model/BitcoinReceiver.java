...
import com.jaguar.param.BitcoinReceiverListParams;
import com.jaguar.param.BitcoinReceiverRetrieveParams;
...
public class BitcoinReceiver extends ApiResource implements PaymentSource {
   ...
   */
  public static BitcoinReceiverCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static BitcoinReceiverCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/bitcoin/receivers");
  ...
  public static BitcoinReceiverCollection list(
      BitcoinReceiverListParams params, RequestOptions options) throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/bitcoin/receivers");
    return ApiResource.requestCollection(url, params, BitcoinReceiverCollection.class, options);
  }

  /** Retrieves the Bitcoin receiver with the given ID. */
  public static BitcoinReceiver retrieve(String id) throws JaguarException {
    return retrieve(id, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves the Bitcoin receiver with the given ID. */
  public static BitcoinReceiver retrieve(String id, RequestOptions options) throws JaguarException {
