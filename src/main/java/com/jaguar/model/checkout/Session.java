...
import com.jaguar.model.LineItem;
import com.jaguar.model.LineItemCollection;
import com.jaguar.model.PaymentIntent;
import com.jaguar.model.SetupIntent;
import com.jaguar.model.ShippingDetails;
import com.jaguar.model.ShippingRate;
import com.jaguar.model.JaguarObject;
import com.jaguar.model.Subscription;
import com.jaguar.net.ApiResource;
import com.jaguar.net.RequestOptions;
import com.jaguar.param.checkout.SessionCreateParams;
import com.jaguar.param.checkout.SessionExpireParams;
import com.jaguar.param.checkout.SessionListLineItemsParams;
import com.jaguar.param.checkout.SessionListParams;
import com.jaguar.param.checkout.SessionRetrieveParams;
...
public class Session extends ApiResource implements HasId {
  ...
  public static SessionCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static SessionCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/checkout/sessions");
    return ApiResource.requestCollection(url, params, SessionCollection.class, options);
  }

  /** Returns a list of Checkout Sessions. */
  public static SessionCollection list(SessionListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
  ...
  public static Session retrieve(String session) throws JaguarException {
    return retrieve(session, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves a Session object. */
  public static Session retrieve(String session, RequestOptions options) throws JaguarException {
  ...
  public static Session retrieve(
      String session, SessionRetrieveParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  public static Session create(Map<String, Object> params) throws JaguarException {
  ...
  /** Creates a Session object. */
  public static Session create(SessionCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
   ...
   */
  public Session expire() throws JaguarException {
   ...
   * a message saying the Session is expired.
   */
  public Session expire(RequestOptions options) throws JaguarException {
   ...
   * a message saying the Session is expired.
   */
  public Session expire(Map<String, Object> params) throws JaguarException {
   ...
   * a message saying the Session is expired.
   */
  public Session expire(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * a message saying the Session is expired.
   */
  public Session expire(SessionExpireParams params) throws JaguarException {
    return expire(params, (RequestOptions) null);
  }
   ...
   * a message saying the Session is expired.
   */
  public Session expire(SessionExpireParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class AfterExpiration extends JaguarObject {
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Recovery extends JaguarObject {
      /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Consent extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class ConsentCollection extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class CustomerDetails extends JaguarObject {
    /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class TaxID extends JaguarObject {
      /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class PhoneNumberCollection extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class ShippingAddressCollection extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class ShippingOption extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class TaxIDCollection extends JaguarObject {
