...
import com.jaguar.param.InvoiceCreateParams;
import com.jaguar.param.InvoiceFinalizeInvoiceParams;
import com.jaguar.param.InvoiceListParams;
import com.jaguar.param.InvoiceMarkUncollectibleParams;
import com.jaguar.param.InvoicePayParams;
import com.jaguar.param.InvoiceRetrieveParams;
import com.jaguar.param.InvoiceSendInvoiceParams;
import com.jaguar.param.InvoiceUpcomingParams;
import com.jaguar.param.InvoiceUpdateParams;
import com.jaguar.param.InvoiceVoidInvoiceParams;
...
public class Invoice extends ApiResource implements HasId, MetadataStore<Invoice> {
  ...
  JaguarError lastFinalizationError;
   ...
   */
  public static InvoiceCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static InvoiceCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/invoices");
   ...
   * returned sorted by creation date, with the most recently created invoices appearing first.
   */
  public static InvoiceCollection list(InvoiceListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   */
  public static Invoice upcoming() throws JaguarException {
   ...
   * upcoming invoice resource.
   */
  public static Invoice upcoming(Map<String, Object> params) throws JaguarException {
  ...
  public static Invoice upcoming(Map<String, Object> params, RequestOptions options)
      throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/invoices/upcoming");
   ...
   * upcoming invoice resource.
   */
  public static Invoice upcoming(InvoiceUpcomingParams params) throws JaguarException {
    return upcoming(params, (RequestOptions) null);
  }
   ...
   */
  public static Invoice create(Map<String, Object> params) throws JaguarException {
   ...
   * href="https://stripe.com/docs/api#send_invoice">send</a> the invoice to your customers.
   */
  public static Invoice create(InvoiceCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  public static Invoice retrieve(String invoice) throws JaguarException {
    return retrieve(invoice, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves the invoice with the given ID. */
  public static Invoice retrieve(String invoice, RequestOptions options) throws JaguarException {
  ...
  public static Invoice retrieve(
      String invoice, InvoiceRetrieveParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  @Override
  public Invoice update(Map<String, Object> params) throws JaguarException {
   ...
   */
  @Override
  public Invoice update(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * invoices, pass <code>auto_advance=false</code>.
   */
  public Invoice update(InvoiceUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   * invoices, pass <code>auto_advance=false</code>.
   */
  public Invoice update(InvoiceUpdateParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  public Invoice delete() throws JaguarException {
   ...
   * href="https://stripe.com/docs/api#void_invoice">voided</a>.
   */
  public Invoice delete(RequestOptions options) throws JaguarException {
   ...
   * href="https://stripe.com/docs/api#void_invoice">voided</a>.
   */
  public Invoice delete(Map<String, Object> params) throws JaguarException {
   ...
   * href="https://stripe.com/docs/api#void_invoice">voided</a>.
   */
  public Invoice delete(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  public Invoice pay() throws JaguarException {
   ...
   * or for some other reason, you can do so.
   */
  public Invoice pay(RequestOptions options) throws JaguarException {
   ...
   * or for some other reason, you can do so.
   */
  public Invoice pay(Map<String, Object> params) throws JaguarException {
   ...
   * or for some other reason, you can do so.
   */
  public Invoice pay(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * or for some other reason, you can do so.
   */
  public Invoice pay(InvoicePayParams params) throws JaguarException {
    return pay(params, (RequestOptions) null);
  }
   ...
   * or for some other reason, you can do so.
   */
  public Invoice pay(InvoicePayParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  public Invoice finalizeInvoice() throws JaguarException {
   ...
   * However, if you’d like to finalize a draft invoice manually, you can do so using this method.
   */
  public Invoice finalizeInvoice(RequestOptions options) throws JaguarException {
   ...
   * However, if you’d like to finalize a draft invoice manually, you can do so using this method.
   */
  public Invoice finalizeInvoice(Map<String, Object> params) throws JaguarException {
   ...
   * However, if you’d like to finalize a draft invoice manually, you can do so using this method.
   */
  public Invoice finalizeInvoice(InvoiceFinalizeInvoiceParams params) throws JaguarException {
    return finalizeInvoice(params, (RequestOptions) null);
  }
   ...
   */
  public Invoice sendInvoice() throws JaguarException {
   ...
   * invoice.sent</code> event.
   */
  public Invoice sendInvoice(RequestOptions options) throws JaguarException {
   ...
   * invoice.sent</code> event.
   */
  public Invoice sendInvoice(Map<String, Object> params) throws JaguarException {
   ...
   * invoice.sent</code> event.
   */
  public Invoice sendInvoice(InvoiceSendInvoiceParams params) throws JaguarException {
    return sendInvoice(params, (RequestOptions) null);
  }
   ...
   */
  public Invoice markUncollectible() throws JaguarException {
   ...
   * written off for accounting purposes.
   */
  public Invoice markUncollectible(RequestOptions options) throws JaguarException {
   ...
   * written off for accounting purposes.
   */
  public Invoice markUncollectible(Map<String, Object> params) throws JaguarException {
   ...
   * written off for accounting purposes.
   */
  public Invoice markUncollectible(InvoiceMarkUncollectibleParams params) throws JaguarException {
    return markUncollectible(params, (RequestOptions) null);
  }
   ...
   */
  public Invoice voidInvoice() throws JaguarException {
   ...
   * finalized invoices and maintains a papertrail where the invoice can still be found.
   */
  public Invoice voidInvoice(RequestOptions options) throws JaguarException {
   ...
   * finalized invoices and maintains a papertrail where the invoice can still be found.
   */
  public Invoice voidInvoice(Map<String, Object> params) throws JaguarException {
   ...
   * finalized invoices and maintains a papertrail where the invoice can still be found.
   */
  public Invoice voidInvoice(InvoiceVoidInvoiceParams params) throws JaguarException {
    return voidInvoice(params, (RequestOptions) null);
  }
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class AutomaticTax extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class CustomField extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class CustomerTaxId extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class DiscountAmount extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class PaymentMethodOptions extends JaguarObject {
    /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class AcssDebit extends JaguarObject {
      ...
      @Setter
      @EqualsAndHashCode(callSuper = false)
      public static class MandateOptions extends JaguarObject {
        /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Bancontact extends JaguarObject {
      /**
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class Card extends JaguarObject {
      /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class PaymentSettings extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class StatusTransitions extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class TaxAmount extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class ThresholdItemReason extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class ThresholdReason extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class TransferData extends JaguarObject {
    /**
