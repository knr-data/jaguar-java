...
import com.jaguar.param.WebhookEndpointListParams;
import com.jaguar.param.WebhookEndpointRetrieveParams;
import com.jaguar.param.WebhookEndpointUpdateParams;
...
public class WebhookEndpoint extends ApiResource implements HasId, MetadataStore<WebhookEndpoint> {
  ...
  public static WebhookEndpointCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static WebhookEndpointCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/webhook_endpoints");
  ...
  public static WebhookEndpointCollection list(
      WebhookEndpointListParams params, RequestOptions options) throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/webhook_endpoints");
    return ApiResource.requestCollection(url, params, WebhookEndpointCollection.class, options);
  }

  /** Retrieves the webhook endpoint with the given ID. */
  public static WebhookEndpoint retrieve(String webhookEndpoint) throws JaguarException {
   ...
   */
  public static WebhookEndpoint create(Map<String, Object> params) throws JaguarException {
   ...
   * settings</a> section of the Dashboard.
   */
  public static WebhookEndpoint create(WebhookEndpointCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
   ...
   */
  @Override
  public WebhookEndpoint update(Map<String, Object> params) throws JaguarException {
   ...
   * enabled_events</code>, and the status of your endpoint.
   */
  public WebhookEndpoint update(WebhookEndpointUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   */
  public WebhookEndpoint delete() throws JaguarException {
   ...
   * the Stripe dashboard.
   */
  public WebhookEndpoint delete(RequestOptions options) throws JaguarException {
   ...
   * the Stripe dashboard.
   */
  public WebhookEndpoint delete(Map<String, Object> params) throws JaguarException {
