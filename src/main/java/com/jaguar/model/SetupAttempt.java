...
import com.jaguar.param.SetupAttemptListParams;
...
public class SetupAttempt extends ApiResource implements HasId {
  ...
  public static SetupAttemptCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static SetupAttemptCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/setup_attempts");
    return ApiResource.requestCollection(url, params, SetupAttemptCollection.class, options);
  }

  /** Returns a list of SetupAttempts associated with a provided SetupIntent. */
  public static SetupAttemptCollection list(SetupAttemptListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
