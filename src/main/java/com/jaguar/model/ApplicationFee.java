...
import com.jaguar.param.ApplicationFeeListParams;
import com.jaguar.param.ApplicationFeeRetrieveParams;
...
public class ApplicationFee extends ApiResource implements BalanceTransactionSource {
   ...
   */
  public static ApplicationFeeCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static ApplicationFeeCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/application_fees");
  ...
  public static ApplicationFeeCollection list(
      ApplicationFeeListParams params, RequestOptions options) throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/application_fees");
    return ApiResource.requestCollection(url, params, ApplicationFeeCollection.class, options);
  }
   ...
   */
  public static ApplicationFee retrieve(String id) throws JaguarException {
   ...
   * information is returned when refunding the application fee.
   */
  public static ApplicationFee retrieve(String id, RequestOptions options) throws JaguarException {
