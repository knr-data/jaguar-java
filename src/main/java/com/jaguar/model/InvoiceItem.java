...
import com.jaguar.param.InvoiceItemCreateParams;
import com.jaguar.param.InvoiceItemListParams;
import com.jaguar.param.InvoiceItemRetrieveParams;
import com.jaguar.param.InvoiceItemUpdateParams;
...
public class InvoiceItem extends ApiResource implements HasId, MetadataStore<InvoiceItem> {
   ...
   */
  public static InvoiceItemCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static InvoiceItemCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/invoiceitems");
   ...
   * the most recently created invoice items appearing first.
   */
  public static InvoiceItemCollection list(InvoiceItemListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   */
  public static InvoiceItem create(Map<String, Object> params) throws JaguarException {
   ...
   * specified, the item will be on the next invoice created for the customer specified.
   */
  public static InvoiceItem create(InvoiceItemCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  public static InvoiceItem retrieve(String invoiceitem) throws JaguarException {
   ...
   */
  @Override
  public InvoiceItem update(Map<String, Object> params) throws JaguarException {
   ...
   * invoice item is only possible before the invoice it’s attached to is closed.
   */
  public InvoiceItem update(InvoiceItemUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   */
  public InvoiceItem delete() throws JaguarException {
   ...
   * when they’re not attached to invoices, or if it’s attached to a draft invoice.
   */
  public InvoiceItem delete(RequestOptions options) throws JaguarException {
   ...
   * when they’re not attached to invoices, or if it’s attached to a draft invoice.
   */
  public InvoiceItem delete(Map<String, Object> params) throws JaguarException {
