...
import com.jaguar.param.SourceCreateParams;
import com.jaguar.param.SourceDetachParams;
import com.jaguar.param.SourceRetrieveParams;
import com.jaguar.param.SourceSourceTransactionsParams;
import com.jaguar.param.SourceUpdateParams;
import com.jaguar.param.SourceVerifyParams;
...
public class Source extends ApiResource implements MetadataStore<Source>, PaymentSource {
  ...
  public Source detach() throws JaguarException {
    return detach((Map<String, Object>) null, (RequestOptions) null);
  }

  /** Delete a specified source for a given customer. */
  public Source detach(Map<String, Object> params) throws JaguarException {
    return detach(params, (RequestOptions) null);
  }

  /** Delete a specified source for a given customer. */
  public Source detach(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  /** Delete a specified source for a given customer. */
  public Source detach(SourceDetachParams params) throws JaguarException {
    return detach(params, (RequestOptions) null);
  }

  /** Delete a specified source for a given customer. */
  public Source detach(SourceDetachParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   */
  public static Source retrieve(String source) throws JaguarException {
   ...
   * and Stripe will return the corresponding up-to-date source object information.
   */
  public static Source retrieve(String source, RequestOptions options) throws JaguarException {
  ...
  public static Source retrieve(String source, Map<String, Object> params, RequestOptions options)
    ...
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/sources/%s", ApiResource.urlEncodeId(source)));
  ...
  public static Source create(Map<String, Object> params) throws JaguarException {
  ...
  public static Source create(Map<String, Object> params, RequestOptions options)
      throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/sources");
    return ApiResource.request(ApiResource.RequestMethod.POST, url, params, Source.class, options);
  }

  /** Creates a new source object. */
  public static Source create(SourceCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
   ...
   */
  @Override
  public Source update(Map<String, Object> params) throws JaguarException {
   ...
   */
  @Override
  public Source update(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
   ...
   * our <a href="https://stripe.com/docs/sources">payment method guides</a> for more detail.
   */
  public Source update(SourceUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   * our <a href="https://stripe.com/docs/sources">payment method guides</a> for more detail.
   */
  public Source update(SourceUpdateParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  public Source verify(Map<String, Object> params) throws JaguarException {
    return verify(params, (RequestOptions) null);
  }

  /** Verify a given source. */
  public Source verify(Map<String, Object> params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  /** Verify a given source. */
  public Source verify(SourceVerifyParams params) throws JaguarException {
    return verify(params, (RequestOptions) null);
  }

  /** Verify a given source. */
  public Source verify(SourceVerifyParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  public SourceTransactionCollection sourceTransactions() throws JaguarException {
  ...
  /** List source transactions for a given source. */
  public SourceTransactionCollection sourceTransactions(
      SourceSourceTransactionsParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(),
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class CodeVerificationFlow extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Order extends JaguarObject {
    /**
     * A positive integer in the smallest currency unit (that is, 100 cents for $1.00, or 1 for ¥1,
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class OrderItem extends JaguarObject {
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Owner extends JaguarObject {
    /** Owner's address. */
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class ReceiverFlow extends JaguarObject {
    /**
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class RedirectFlow extends JaguarObject {
    /**
