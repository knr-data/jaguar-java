...
final class EventDataClassLookup {
  private static final Map<String, Class<? extends JaguarObject>> classLookup = new HashMap<>();
  ...
  static {
    ...
    classLookup.put(
        "billing_portal.configuration", com.jaguar.model.billingportal.Configuration.class);
    classLookup.put("billing_portal.session", com.jaguar.model.billingportal.Session.class);

    classLookup.put("checkout.session", com.jaguar.model.checkout.Session.class);

    classLookup.put(
        "identity.verification_report", com.jaguar.model.identity.VerificationReport.class);
    classLookup.put(
        "identity.verification_session", com.jaguar.model.identity.VerificationSession.class);

    classLookup.put("issuing.authorization", com.jaguar.model.issuing.Authorization.class);
    classLookup.put("issuing.card", com.jaguar.model.issuing.Card.class);
    classLookup.put("issuing.cardholder", com.jaguar.model.issuing.Cardholder.class);
    classLookup.put("issuing.dispute", com.jaguar.model.issuing.Dispute.class);
    classLookup.put("issuing.transaction", com.jaguar.model.issuing.Transaction.class);

    classLookup.put("radar.early_fraud_warning", com.jaguar.model.radar.EarlyFraudWarning.class);
    classLookup.put("radar.value_list", com.jaguar.model.radar.ValueList.class);
    classLookup.put("radar.value_list_item", com.jaguar.model.radar.ValueListItem.class);

    classLookup.put("reporting.report_run", com.jaguar.model.reporting.ReportRun.class);
    classLookup.put("reporting.report_type", com.jaguar.model.reporting.ReportType.class);

    classLookup.put("scheduled_query_run", com.jaguar.model.sigma.ScheduledQueryRun.class);

    classLookup.put("terminal.connection_token", com.jaguar.model.terminal.ConnectionToken.class);
    classLookup.put("terminal.location", com.jaguar.model.terminal.Location.class);
    classLookup.put("terminal.reader", com.jaguar.model.terminal.Reader.class);
  }

  public static Class<? extends JaguarObject> findClass(String objectType) {
