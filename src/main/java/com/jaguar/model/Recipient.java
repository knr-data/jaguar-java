...
import com.jaguar.param.RecipientCreateParams;
import com.jaguar.param.RecipientListParams;
import com.jaguar.param.RecipientRetrieveParams;
import com.jaguar.param.RecipientUpdateParams;
...
public class Recipient extends ApiResource implements HasId, MetadataStore<Recipient> {
   ...
   */
  public static RecipientCollection list(Map<String, Object> params) throws JaguarException {
  ...
  public static RecipientCollection list(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/recipients");
   ...
   * the most recently created recipients appearing first.
   */
  public static RecipientCollection list(RecipientListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
   ...
   */
  public static Recipient create(Map<String, Object> params) throws JaguarException {
   ...
   * verifies the recipient’s bank account information or debit card, if either is provided.
   */
  public static Recipient create(RecipientCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
   ...
   */
  public static Recipient retrieve(String id) throws JaguarException {
   ...
   * identifier that was returned upon recipient creation.
   */
  public static Recipient retrieve(String id, RequestOptions options) throws JaguarException {
  ...
  public static Recipient retrieve(String id, Map<String, Object> params, RequestOptions options)
    ...
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/recipients/%s", ApiResource.urlEncodeId(id)));
    return ApiResource.request(
  ...
  public static Recipient retrieve(
      String id, RecipientRetrieveParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/recipients/%s", ApiResource.urlEncodeId(id)));
   ...
   */
  @Override
  public Recipient update(Map<String, Object> params) throws JaguarException {
   ...
   * you update the bank account, the bank account validation will automatically be rerun.
   */
  public Recipient update(RecipientUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
  ...
  public Recipient delete() throws JaguarException {
    return delete((Map<String, Object>) null, (RequestOptions) null);
  }

  /** Permanently deletes a recipient. It cannot be undone. */
  public Recipient delete(RequestOptions options) throws JaguarException {
    return delete((Map<String, Object>) null, options);
  }

  /** Permanently deletes a recipient. It cannot be undone. */
  public Recipient delete(Map<String, Object> params) throws JaguarException {
