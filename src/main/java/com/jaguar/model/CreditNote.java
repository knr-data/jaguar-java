...
import com.jaguar.param.CreditNoteCreateParams;
import com.jaguar.param.CreditNoteListParams;
import com.jaguar.param.CreditNotePreviewParams;
import com.jaguar.param.CreditNoteRetrieveParams;
import com.jaguar.param.CreditNoteUpdateParams;
import com.jaguar.param.CreditNoteVoidCreditNoteParams;
...
public class CreditNote extends ApiResource implements HasId, MetadataStore<CreditNote> {
   ...
   */
  public static CreditNote create(Map<String, Object> params) throws JaguarException {
  ...
  public static CreditNote create(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/credit_notes");
   ...
   * credit note creation.
   */
  public static CreditNote create(CreditNoteCreateParams params) throws JaguarException {
    return create(params, (RequestOptions) null);
  }
  ...
  public static CreditNote preview(Map<String, Object> params) throws JaguarException {
  ...
  public static CreditNote preview(Map<String, Object> params, RequestOptions options)
      throws JaguarException {
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/credit_notes/preview");
    return ApiResource.request(
        ApiResource.RequestMethod.GET, url, params, CreditNote.class, options);
  }

  /** Get a preview of a credit note without creating it. */
  public static CreditNote preview(CreditNotePreviewParams params) throws JaguarException {
    return preview(params, (RequestOptions) null);
  }
  ...
  public static CreditNote retrieve(String id) throws JaguarException {
    return retrieve(id, (Map<String, Object>) null, (RequestOptions) null);
  }

  /** Retrieves the credit note object with the given identifier. */
  public static CreditNote retrieve(String id, RequestOptions options) throws JaguarException {
  ...
  public static CreditNote retrieve(String id, Map<String, Object> params, RequestOptions options)
    ...
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/credit_notes/%s", ApiResource.urlEncodeId(id)));
    return ApiResource.request(
        ApiResource.RequestMethod.GET, url, params, CreditNote.class, options);
  }
  ...
  public static CreditNote retrieve(
      String id, CreditNoteRetrieveParams params, RequestOptions options) throws JaguarException {
    String url =
        String.format(
            "%s%s",
            Jaguar.getApiBase(), String.format("/v1/credit_notes/%s", ApiResource.urlEncodeId(id)));
  ...
  public static CreditNoteCollection list(Map<String, Object> params) throws JaguarException {
  ...
  /** Returns a list of credit notes. */
  public static CreditNoteCollection list(CreditNoteListParams params) throws JaguarException {
    return list(params, (RequestOptions) null);
  }
  ...
  @Override
  public CreditNote update(Map<String, Object> params) throws JaguarException {
  ...
  /** Updates an existing credit note. */
  public CreditNote update(CreditNoteUpdateParams params) throws JaguarException {
    return update(params, (RequestOptions) null);
  }
   ...
   * href="https://stripe.com/docs/billing/invoices/credit-notes#voiding">voiding credit notes</a>.
   */
  public CreditNote voidCreditNote() throws JaguarException {
   ...
   * href="https://stripe.com/docs/billing/invoices/credit-notes#voiding">voiding credit notes</a>.
   */
  public CreditNote voidCreditNote(RequestOptions options) throws JaguarException {
   ...
   * href="https://stripe.com/docs/billing/invoices/credit-notes#voiding">voiding credit notes</a>.
   */
  public CreditNote voidCreditNote(Map<String, Object> params) throws JaguarException {
   ...
   * href="https://stripe.com/docs/billing/invoices/credit-notes#voiding">voiding credit notes</a>.
   */
  public CreditNote voidCreditNote(CreditNoteVoidCreditNoteParams params) throws JaguarException {
    return voidCreditNote(params, (RequestOptions) null);
  }
