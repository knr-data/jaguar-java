...
import com.jaguar.param.BalanceRetrieveParams;
...
public class Balance extends ApiResource {
   ...
   */
  public static Balance retrieve() throws JaguarException {
   ...
   * for negative balances</a>.
   */
  public static Balance retrieve(RequestOptions options) throws JaguarException {
  ...
  public static Balance retrieve(Map<String, Object> params, RequestOptions options)
    ...
    String url = String.format("%s%s", Jaguar.getApiBase(), "/v1/balance");
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Money extends JaguarObject {
    /** Balance amount. */
    ...
    @Setter
    @EqualsAndHashCode(callSuper = false)
    public static class SourceTypes extends JaguarObject {
