...
public class HttpURLConnectionClient extends HttpClient {
   ...
   */
  @Override
  public JaguarResponseStream requestStream(JaguarRequest request) throws ApiConnectionException {
    try {
      ...
      return new JaguarResponseStream(responseCode, headers, responseStream);
   ...
   */
  @Override
  public JaguarResponse request(JaguarRequest request) throws ApiConnectionException {
    final JaguarResponseStream responseStream = requestStream(request);
    try {
  ...
  static HttpHeaders getHeaders(JaguarRequest request) {
  ...
  private static HttpURLConnection createStripeConnection(JaguarRequest request)
