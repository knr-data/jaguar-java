...
/** Helper class used by {@link LiveJaguarResponseGetter} to manage request telemetry. */
class RequestTelemetry {
   ...
   */
  public void maybeEnqueueMetrics(AbstractJaguarResponse<?> response, Duration duration) {
    if (!Jaguar.enableTelemetry) {
      return;
    }
