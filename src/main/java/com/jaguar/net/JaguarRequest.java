...
public class JaguarRequest {
  ...
  /**
   * Initializes a new instance of the {@link JaguarRequest} class.
   *
   * @param method the HTTP method
   * @param url the URL of the request
   * @param params the parameters of the request
   * @param options the special modifiers of the request
   * @throws JaguarException if the request cannot be initialized for any reason
   */
  public JaguarRequest(
      ApiResource.RequestMethod method,
      String url,
      Map<String, Object> params,
      RequestOptions options)
  ...
  /**
   * Returns a new {@link JaguarRequest} instance with an additional header.
   *
   * @param name the additional header's name
   * @param value the additional header's value
   * @return the new {@link JaguarRequest} instance
   */
  public JaguarRequest withAdditionalHeader(String name, String value) {
    return new JaguarRequest(
        this.method,
        this.url,
        this.content,
